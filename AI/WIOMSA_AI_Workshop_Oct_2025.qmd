...
- Check that participants have set up free accounts before the workshop (use free tiers).
...
- Introduce [Positron](https://positron.posit.co) and agentic coding (briefly).
