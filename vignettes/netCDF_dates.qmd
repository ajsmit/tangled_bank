...
```{r code-length-sst-files}
length(SST_files)
```

The full path and filenames are:

```{r code-sst-files-showing-the-first}
...
```{r code-basename-sst-files-length-sst-files}
...
```{r code-fname-basename-sst-files-the}
