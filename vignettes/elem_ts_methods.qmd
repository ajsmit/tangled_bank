...
```{r code-global-options, include = FALSE}
...
```{r code-interpolate-data, include = TRUE}
...
```{r code-auto-arima-diatoms, include = FALSE}
...
```{r code-pre-white, warning = FALSE}
...
```{r fn-geochem-ts-plot, echo = TRUE, warning = FALSE}
#| fig-height: 7
...
```{r fig-wavelet-geochem, echo = TRUE, include = TRUE}
...
```{r code-wavelet-geochem-reconstruct}
...
```{r code-pc1-bp-bandpass-pc1, pc1.1-bp}
#| fig-height: 7
...
```{r code-pc1-bp-bandpass-pc1-2, pc1.2-bp}
#| fig-height: 7
...
```{r code-wavelet-pc2-plot, echo = TRUE}
...
```{r fig-wavelet-paralia, echo = TRUE}
...
```{r code-wavelet-paralia-plot, echo = TRUE}
wt.image(w3, siglvl = 0.05, col.contour = "black", color.key = "quantile", 
         legend.params = list(lab = "wavelet power levels", label.digits = 2, 
                              shrink = 1.0), timelab = "Years", 
         periodlab = "Period", lwd = 1, plot.ridge = FALSE)
...
```{r fig-wavelet-benthics, echo = TRUE}
...
```{r code-wavelet-benthics-plot, echo = TRUE}
...
```{r fig-wavelet-offshore, echo = TRUE}
...
```{r code-wavelet-offshore-plot, echo = TRUE}
