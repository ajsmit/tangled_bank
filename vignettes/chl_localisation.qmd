...
```{r code-chldir-users-ajsmit-library}
#| cache: false
#| eval: false
# chlorophyll-*a*
...
```{r fig-plot-chl-st-cir-sfc-reset}
#| eval: false
...
```{r fig-plot-chl-st-cir-bbox-reset}
#| eval: false
...
```{r code-chl-calc-safe-sights-lag-works}
#| eval: false
...
```{r code-sights-chl-lag-0-sights}
#| eval: false
...
```{r code-sights-chl-lag-8-sights}
#| eval: false
