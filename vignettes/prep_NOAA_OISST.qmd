...
```{r code-download-data, eval=FALSE}
...
```{r fn-noaa-dl, eval=FALSE}
# This function will go about downloading each day of data as a NetCDF file
# Note that this will download files into a 'data/BCB744/OISST' folder in the root directory
...
OISST_url_daily_dl <- function(target_URL){
  dir.create("data/BCB744/OISST", showWarnings = F)
  file_name <- paste0("data/BCB744/OISST/", sapply(strsplit(target_URL, split = "/"), "[[", 10))
...
OISST_files <- dir("data/BCB744/OISST", full.names = T)
