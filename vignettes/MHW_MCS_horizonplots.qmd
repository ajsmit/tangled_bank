...
```{r code-events-thresh-fun-sst-wa-climatologyperiod}
events <- thresh_fun(sst_WA, climatologyPeriod = c("1983-01-01", "2012-12-31"))
```

```{r code-horizon-plot-events-title-extreme}
#| fig-height: 10
#| fig-width: 8
