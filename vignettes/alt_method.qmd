...
Create a folder on your server where all the data will be received, for example: `/path/to/your/data/netCDF`.
...
```{r fn-netcdf2csv, echo = TRUE, eval = FALSE}
# Load packages -----------------------------------------------------------
...
```{r code-detectmhws, echo = TRUE, eval = FALSE}
# Execute the code --------------------------------------------------------
