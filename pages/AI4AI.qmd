...
In OpenAI Desktop Application, you can follow the menu path `Settings > Personlization > Customize ChatGPT` to set up a custom prompt for the AI model. This is useful for setting up a prompt that you use frequently, such as for a specific module or project.
