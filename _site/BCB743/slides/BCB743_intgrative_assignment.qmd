...
Submit a R markdown script and the knitted output for the Integrative Assignment by no later than 11:59 on Tuesday 20 September 2022. Label the script as follows: **`BCB743_<Name>_<Surname>_Integrative_Assignment.qmd`** and **`BCB743_<Name>_<Surname>_Integrative_Assignment.html`** (or use MS Word format).
