...
const GOOGLE_SCRIPT_URL = 'YOUR_GOOGLE_APPS_SCRIPT_URL'; // Replace with your deployed script URL
    ...
    <div className="min-h-screen bg-gray-100 py-8">
      <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
        <div className="bg-white shadow-lg">
          {submitStatus.status && (
            <Alert className={`mb-4 ${submitStatus.status === 'success' ? 'bg-green-50' : 'bg-red-50'}`}>
              <AlertDescription>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-gray-50 p-4 rounded">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Code Formatting & Presentation (%)</label>
                  <input
                    type="number"
                    className="w-48 p-2 border rounded bg-white"
