...
- **Reading:** [PI Curves: Jassby and Platt](Jassby-platt.qmd)
:::
...
1. Calculate the photosynthetic rate $P(I)$ for each replicate.
2. Calculate the mean and standard deviation of $P(I)$ at each light intensity.
3. [Exhibit 1:]{.my-highlight} Plot the mean $P(I)$ values with error bars (±1 SD) as a function of light intensity.
4. [Exhibit 2:]{.my-highlight} Fit the data to the model to estimate all the parameters of the modified Jassby and Platt model. You can 'fit' the model by hand or, for bonus marks, use a curve-fitting tool in a spreadsheet or programming language. Neatly present these data as a table.
5. [Exhibit 3:]{.my-highlight} Discuss the results in the context of the model and the experimental data. What do the parameters of the model tell you about the photosynthetic performance of the plant? What are the limitations of the model? How does all of this relate to the theory of photosynthesis (i.e. the relationship between light intensity and photosynthetic rate)?
6. [Exhibit 4:]{.my-highlight} Why is it necessary to control the environmental conditions during the experiment? Which conditions, and why? What are any other potential sources of error in this experiment?
7. [Exhibit 5:]{.my-highlight} In this experiment we measured oxygen evolution. Name a few other approaches we can use to measure photosynthetic rate.
8. Submit your work as a MS Word file on iKamva.
