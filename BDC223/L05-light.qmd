...
-   Explain what light is, and understand frequency, wavelength, and energy.
...
This lecture treats light as both a physical quantity and a biological resource. We cover wavelength, frequency, energy, photons, photosynthetically active radiation, and the ways in which atmosphere, land, and water change the quantity and quality of light available to plants.
:::
...
Today we turn to light. For plants, light is not just background illumination; it is the energy source that drives photosynthesis. To understand plant ecophysiology, you need to understand what light is physically, how it is measured, and how environments modify it.
...
On land, spectral variation is smaller than in the sea, but underwater the differences become pronounced. Red wavelengths are absorbed quickly, whereas blue light penetrates much deeper. That is why the ocean looks blue and why marine photosynthetic organisms experience a very different light field from terrestrial plants.
