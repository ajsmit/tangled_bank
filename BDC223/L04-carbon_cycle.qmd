...
What is happened in the intervening sixty years is that people have managed to extend this graph further to the left, using various scientific methods that allow us to peer deeper into our planet's history. We can now look further back in time and, similarly, using global climate models, we are even able to project forward, about a hundred or a hundred and fifty years into the future. After we are all gone, we do have a reasonable degree of certainty about what the future world will be like, at least with regard to the climate, as the mathematics and science align quite reliably. We will delve into the predictive capacity of these models later.
