...
I just need some advice from sir. I am starting to study today and I just wanted to know what do you think is the best way to study for sir's exam. I am asking because I studied really hard for the midterm tests but I still got low marks lol. So I just wanted to know if there is maybe a different approach that I can take.\
\
...
\
So far I have just read through the articles but is there any advice that sir can give me please?
...
I can tell you is *how* you can test your understanding. Explain the thing you are trying to understand to a friend or family member. If your explanation of the topic brings about an understanding in the other person, then you yourself understand it. At least this process will tell you where your own understanding starts to fail. As Richard Feynman said, "If you cannot explain something to a 7-year old, you do not understand it yourself." Or something like that.

For someone who finds it easier to memorise stuff and more challenging to understand... I do not know what that feels like as I have no personal experience or frame of reference that allows me to place myself into your shoes. But here is the theory:
...
Good day sir, there is not a good definition of climatic envelopes on google. Sir spoke about it in consequences in climate change. Not really sure what it specifically is.
...
Yes. But there is only a certain range of env conditions plants can acclimatise to, and exceeding those limits will still cause stress.

Acclimatisation can happen over minutes to hours to days. Or seasonally. But if env conditions exceed the normal range of variability they will become stressed.
...
Do I need to search an article to support that or can I leave it as is since it is something I have recently seen with friends, family and on social media platforms (how organic food is the "right food" to consume).

### Answer

I think it is commonly knowledge based on lived experience that organic foods have become more widely consumed. So no need to ref that. But the claims that people make about why organic foods are 'better' often do not have factual support. So, if you state that it is better for whatever reason, that needs factual support. If no support is available, your conclusion would have to be that the claim is dogma, i.e., untested, unsubstantiated, wishful thinking, etc.
...
Not no oxygen. But very little. Usually anoxia is reached at O2 concentrations below 2mg/L. Before that low level it is called hypoxia.
...
Eutrophic conditions can cause biomass accumulation of photoautotrophs. During night extremely dense biomass of such accumulations do not photosynthesise but continue to respire. This is when low O2 first starts, and it causes the initial die-off.
...
Biofouling is a process. It is the process by which epiphytes colonise the surface of a basiphyte. The epiphytes in question might be macroalgae, but it is most typically microalgae or bacteria (the latter two collectively called biofilm).
...
I am asking because some students are getting negative values. Regards

Professors response.

"Yes. Why do you think there is a negative value? What does a negative rate mean---i.e. does it apply to the culture medium (where the concentration decreases) or to the seaweed (where it increases)?"
...
Sir, do we consider the only culture volume when calculate our S (substrate conc)? and we use μmol N or μg N units or it does not much matter
...
With multiple flask experiment you said you can calculate update rate (so I am assuming it is a linear graph) and with perturbation you said it is a depletion curve.

With the Michaelis- menten we measure substrate concentration against uptake rate but use perturbation methods (using the gradient for the uptake rate) Since multiple flask also shows uptake rate can you still use this methodology to generate a Michaelis-menten expression? Also would not it have been easier because then you do not have the whole x-axis confusion
...
N cycle. I would say something like this:
...
**What is your personal view Prof?**
...
Ralph Keeling's work is part of the justification. Much more has happened since, especially in the last decade. I do not think a justification to use Anthropocene yet existed in the 1960s, but there is plenty going on now to cause one to make that argument.
...
I guess I am not so much interested in exact dates, but do knowing which part of which century things happened is important. And the correct order of events. The fact is, we know about climate change far longer than people give credit to.

# Question — Question About a Previous Exam Question

Sir, I have been struggling to contextualize the Guideline you gave us on Material and Methods.
...
Otherwise, not too different from the N uptake answer, except we probably will not use the perturbation method.
