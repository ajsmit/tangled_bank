...
Below is a set of coding problems to solve. You have 21 hours from the
end of the Theory Test to complete this section Please write your code
in an R script file and submit it to the iKamva platform by no later
than 8:30 on Tuesday, 18 March 2025.
...
\subsubsection{Q 6.a -- Data Exploration and
Preparation}\label{q-6.a-data-exploration-and-preparation}
