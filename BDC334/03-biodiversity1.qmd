...
There are two kinds of $\beta$-diversity: [species turnover and nestedness-resultant $\beta$-diversity](L02b-biodiversity#sec-betadiversity). The former is the result of species replacement between sites, whereas the latter is the result of species loss or gain between sites. The Sørensen dissimilarity index, $\beta_\text{sør}$, can be decomposed into these two components.
