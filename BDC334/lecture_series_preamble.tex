...
\renewcommand{\maketitle}{%
  \begin{titlepage}
    \centering
    % Logos at top
    \includegraphics[height=3cm]{../images/Faculty_logo.png}\hspace{2cm}
    \includegraphics[height=3cm]{../images/UWC_logo.png}\\[2em]

    % Title lines in large bold
    {\huge\bfseries
      BDC334 Biogeography \& Global Ecology Lecture Series, August 2026\\[0.5em]
