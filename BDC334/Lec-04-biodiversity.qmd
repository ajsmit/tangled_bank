...
| Topic block | Core question | Typical data | Typical output |
|---|---|---|---|
...
In summary, turnover occurs when species replace one another across sites while richness remains similar. Nestedness occurs when species-poor communities form subsets of richer communities.
