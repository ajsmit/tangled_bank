...
format:
  ...
  pdf:
    documentclass: book
    include-in-header: lecture_series_preamble.tex
    ...
    par-skip: 6pt
    pdf-engine: lualatex
    toc: false # we’ll insert our own TOC block
    citecolor: "blue"
    linkcolor: "blue"
    filecolor: "blue"
    urlcolor: "blue"
...
::: center
![](../images/Faculty_logo.png){height=3cm}  ![](../images/UWC-logo.jpg){height=4cm}
:::
...
# BDC334 Biogeography & Global Ecology Lecture Transcript {.unnumbered}
:::

<!-- ![Test axis environment figure](axisTest.tex){#fig-F1} -->
...
::: callout-important
## 2026 schedule and assessment information

These transcripts preserve historical lecture explanations, but they do not provide the 2026 timetable or assessment instructions. No video lectures are provided in 2026. Follow the [2026 BDC334 syllabus](BDC334_syllabus.qmd) for all lecture and Lab dates, submission deadlines, assessment formats, and class-test times.
:::

The transcripts were created using the [SuperWhisper](https://superwhisper.com) AI tool, which uses a combination of machine learning and natural language processing techniques (GPT-4.1 + the Ulta voice model) to transcribe the audio recordings into text. The transcripts were then edited for clarity and accuracy. The prompt I used to convert the audio is:
...
Please consider the lecture transcripts in this book as the core material for your BDC334 module — an online version of this same material is provided on my [Tangled Bank website](https://tangledbank.netlify.app/), specifically the [web pages about BDC334](https://tangledbank.netlify.app/BDC334/BDC334_syllabus.html). Have a look there for further information. Those materials provide supplementary information and should be read alongside the content contained within this book. Everything there is examinable.
...
On the [About](https://tangledbank.netlify.app/BDC334/BDC334_syllabus.html) page, on the left-hand side under the BDC334 website link on Tangled Bank, you will find details about the lecture schedule, when the practical sessions occur, and a collection of other necessary information you will need throughout this module. I will also list the dates and times of the two class tests that you are expected to complete during the module of this module.
...
Your assessments will require you to integrate your understanding from several readings with the lecture material into cohesive responses. This kind of applied knowledge is necessary not only for assessments but also for professional scientific communication. The current assessment components and weightings are listed in the [2026 BDC334 syllabus](BDC334_syllabus.qmd#sec-policy).

Therefore, online, alongside the lecture material and accompanying slides, I'll be providing various papers for you to read. Direct links to the papers are provided — follow those links to download them. I expect you to read and understand all these papers. If there's anything you don't grasp, please discuss it with your classmates or arrange an appointment with me. The current lecture, Lab, and on-request Wednesday periods are listed in the [2026 BDC334 syllabus](BDC334_syllabus.qmd#timetable).
...
- @keith2012macroecology
- @shade2018macroecology
- @mcgill2019and
...
- @chapin2000consequences
- @maxwell2016biodiversity
- @tilman2017future

Week 5:

- @burger2012macroecology
- @costanza1997value
- @costanza2014changes
...
As always, if you have questions or are struggling with particular concepts, you are welcome to reach out to me on WhatsApp, by email, during scheduled classes, or during a Wednesday period arranged on request.

## Labs

The 2026 programme begins with Lab 0, a lecture on AI with no submission, followed by five practical sessions. These sessions take place in the fifth-floor computer lab of the Biodiversity and Conservation Biology Department building. It is expected that you attend all of them. See the [2026 Lab timetable](BDC334_syllabus.qmd#labs) for dates and deadlines.
...
- @sec-lect5 on Multivariate Data and the rest of this page.

The data for this Lab pertains to the Doubs River [@verneaux1973cours; @borcard2011numerical] study and some toy data, which may be found at the links below:

-   The environmental data -- [`DoubsEnv.csv`](../data/BDC334/DoubsEnv.csv)
-   The species data -- [`DoubsSpe.csv`](../data/BDC334/DoubsSpe.csv)
-   The spatial data -- [`DoubsSpa.csv`](../data/BDC334/DoubsSpa.csv)
-   Example xyz data --
...
- @sec-lect5 (in this book) on Multivariate Data and the rest of this page.
...
- [Lecture 4: Biodiversity Concepts](Lec-04-biodiversity.html)

The data for this Lab are the seaweed [@smit2017seaweeds] as well as some toy data at the links below:

- The seaweed species data -- [`SeaweedSpp.csv`](../data/BDC334/seaweed/SeaweedSpp.csv)
- The seaweed environmental data -- [`SeaweedEnv.csv`](../data/BDC334/seaweed/SeaweedEnv.csv)
- The seaweed coastal sections -- [`SeaweedSites.csv`](../data/BDC334/seaweed/SeaweedSites.csv)
- The fictitious light data [`light_levels.csv`](../data/BDC334/light_levels.csv)

### Lab 4

Finally, this Lab accompanies:

- [Lecture 6: Unified Ecology](Lec-06-unified-ecology.html)
...
- The seaweed species data [@smit2017seaweeds] -- [`SeaweedSpp.csv`](../data/BDC334/seaweed/SeaweedSpp.csv)
- The Doubs River species data [@verneaux1973cours; @borcard2011numerical] -- [`DoubsSpe.csv`](../data/BDC334/DoubsSpe.csv)

## 2026 assessment context

There is no essay assessment in 2026. The current mark-carrying components are the assignment, practical, class tests, and quiz listed in the [2026 assessment policy](BDC334_syllabus.qmd#sec-policy). Follow the instructions and deadlines on the syllabus and the relevant Lab pages.

Clear scientific writing and careful adherence to submission instructions remain important professional skills. Focus on the quality of your reasoning, follow the specified file-format and naming conventions, and submit all required work through iKamva.
...
# Lecture 2a {.unnumbered}

## Papers to Read

The first very important paper that you need to read discusses the whole concept of macroecology. The paper was written by Sally Keith and her colleagues, and it was published in $2012$. What is macroecology? It deals with the development of the field over the past $30\text{--}35$ years or so, since the coining of the term by @brown1989macroecology. The paper highlights the necessity of understanding the processes that are linked to the development of structure in biodiversity across the face of Earth. Additionally, it addresses the breaking down of barriers that existed between "old-fashioned" population and community ecology, moving instead towards a far more comprehensive and integrated view of ecology. This integrated perspective brings together knowledge acquired from a wide variety of new applications.
...
The second foundational paper for this week is by Ashley Shade and colleagues published in 2018. It is going to emerge several times during the module of this module, such as in Lecture 3 and Lecture 5. This is essentially a review detailing the core principles of macroecology. It aims to unite ecological understanding across various scales, ranging from the very small to the very large, and spanning local spatial interactions through to global patterns.
...
::: {.content-visible when-format="html"}
![Slide 2](images/BDC334-002.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-002.jpeg}
\caption*{Slide 2}
\end{figure}
:::
...
## Module Structure: Professor Boatwright

::: {.content-visible when-format="html"}
![Slide 3](images/BDC334-003.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-003.jpeg}
\caption*{Slide 3}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 4](images/BDC334-004.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-004.jpeg}
\caption*{Slide 4}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 5](images/BDC334-005.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-005.jpeg}
\caption*{Slide 5}
\end{figure}
:::
...
# Lecture 2b {.unnumbered}

## Definition of Macroecology

::: {.content-visible when-format="html"}
![Slide 6](images/BDC334-006.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-006.jpeg}
\caption*{Slide 6}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 7](images/BDC334-007.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-007.jpeg}
\caption*{Slide 7}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 8](images/BDC334-008.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-008.jpeg}
\caption*{Slide 8}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 9](images/BDC334-009.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-009.jpeg}
\caption*{Slide 9}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 10](images/BDC334-010.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-010.jpeg}
\caption*{Slide 10}
\end{figure}
:::
...
The earliest botanical research conducted in South Africa dates back to 1772 – 1774, when a Swedish botanist named [Carl Peter Thunberg (1743 – 1828)](https://hipsa.org.za/publication/carl-peter-thunberg-travels-at-the-cape-of-good-hope-1772-1775/), who had trained under Carl von Linné (Linnaeus) (1707 – 1778), travelled to South Africa to explore the Western Cape and parts of the Southern Cape region as far east as Addo. Most of his journeys were made on horseback, and each of his three expeditions lasted several months at a time.
...
::: {.content-visible when-format="html"}
![Slide 11](images/BDC334-011.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-011.jpeg}
\caption*{Slide 11}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 12](images/BDC334-012.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-012.jpeg}
\caption*{Slide 12}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 13](images/BDC334-013.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-013.jpeg}
\caption*{Slide 13}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 14](images/BDC334-014.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-014.jpeg}
\caption*{Slide 14}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 17](images/BDC334-017.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-017.jpeg}
\caption*{Slide 17}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 18](images/BDC334-018.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-018.jpeg}
\caption*{Slide 18}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 19](images/BDC334-019.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-019.jpeg}
\caption*{Slide 19}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 20](images/BDC334-020.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-020.jpeg}
\caption*{Slide 20}
\end{figure}
:::
...
# Lecture 3c {.unnumbered}

## The Earth System and Global Change

::: {.content-visible when-format="html"}
![Slide 21](images/BDC334-021.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-021.jpeg}
\caption*{Slide 21}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 22](images/BDC334-022.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-022.jpeg}
\caption*{Slide 22}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 23](images/BDC334-023.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-023.jpeg}
\caption*{Slide 23}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 24](images/BDC334-024.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-024.jpeg}
\caption*{Slide 24}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 26](images/BDC334-026.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-026.jpeg}
\caption*{Slide 26}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 27](images/BDC334-027.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-027.jpeg}
\caption*{Slide 27}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 28](images/BDC334-028.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-028.jpeg}
\caption*{Slide 28}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 29](images/BDC334-029.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-029.jpeg}
\caption*{Slide 29}
\end{figure}
:::
...
To consolidate this material, select two or three examples of environmental gradients — some operating at local, others at regional, and others at global scales — and explain how they can structure biodiversity (Slide 29). Use this as preparation for the current assessment tasks listed in the [2026 BDC334 syllabus](BDC334_syllabus.qmd#sec-policy); there is no essay assessment in 2026.
...
It is important that you accompany your reading of this chapter with the material presented in [Lab 3](Lab-03-biodiversity.html) and the online content on [Tangled Bank](Lec-04-biodiversity.html).
:::

# Lecture 4a {.unnumbered}
...
::: {.content-visible when-format="html"}
![Slide 31](images/BDC334-031.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-031.jpeg}
\caption*{Slide 31}
\end{figure}
:::
...
2.  **Indices (Shannon and Simpson’s):**\
...
::: {.content-visible when-format="html"}
![Slide 32](images/BDC334-032.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-032.jpeg}
\caption*{Slide 32}
\end{figure}
:::
...
# Lecture 4b {.unnumbered}

## Gamma Diversity: the Largest Scale

::: {.content-visible when-format="html"}
![Slide 33](images/BDC334-033.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-033.jpeg}
\caption*{Slide 33}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 34](images/BDC334-034.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-034.jpeg}
\caption*{Slide 34}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 35](images/BDC334-035.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-035.jpeg}
\caption*{Slide 35}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 36](images/BDC334-036.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-036.jpeg}
\caption*{Slide 36}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 37](images/BDC334-037.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-037.jpeg}
\caption*{Slide 37}
\end{figure}
:::
...
We will discuss dissimilarity indices and how to interpret them in detail in a later section of the module, where I shall provide some pre-calculated examples for you to practise with.
...
::: {.content-visible when-format="html"}
![Slide 38](images/BDC334-038.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-038.jpeg}
\caption*{Slide 38}
\end{figure}
:::
...
# Lecture 4c {.unnumbered}

## Introduction to Selecting Diversity Measurements

::: {.content-visible when-format="html"}
![Slide 39](images/BDC334-039.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-039.jpeg}
\caption*{Slide 39}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 40](images/BDC334-040.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-040.jpeg}
\caption*{Slide 40}
\end{figure}
:::
...
Some exercises require you to calculate these indices by hand so that you understand their components. Other calculations use the software specified in the relevant 2026 Lab.
...
::: {.content-visible when-format="html"}
![Slide 41](images/BDC334-041.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-041.jpeg}
\caption*{Slide 41}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 42](images/BDC334-042.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-042.jpeg}
\caption*{Slide 42}
\end{figure}
:::
...
> Be the first person to Send the message "I love Barney the Dinosaur" to the WhatsApp group chat and claim your prize.
...
::: {.content-visible when-format="html"}
![Slide 43](images/BDC334-043.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-043.jpeg}
\caption*{Slide 43}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 44](images/BDC334-044.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-044.jpeg}
\caption*{Slide 44}
\end{figure}
:::
...
You are welcome to make an appointment with me, preferably in groups of three or four or more, if you have questions about these two papers. Use the scheduled classes and on-request Wednesday periods shown in the [2026 timetable](BDC334_syllabus.qmd#timetable).

# Multivariate Data {#sec-lect5}
...
Accompany your reading of in this chapter with the material in [Lab 1](Lab-01-introduction.html), [Lab 2b](Lab-02b-env_dist.html), and [Lab 3](Lab-03-biodiversity.html).
:::

# Lecture 5a {.unnumbered}
...
::: {.content-visible when-format="html"}
![Slide 46](images/BDC334-046.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-046.jpeg}
\caption*{Slide 46}
\end{figure}
:::
...
1.  **Environmental differences:** The environment may be different at the two places. For example, one environment may be too warm, excluding species that prefer colder temperatures. Environmental differences may explain why community compositions vary.

2.  **Neutral theories:** If the differences are not due to the environment, they might be due to other factors, such as species' ability to disperse across the landscape, historical events that shaped the community, or random processes that affect species' presence and abundance. These are often grouped under neutral theories.

3.  **Unmeasured influences:** If it's not due to the environment (or not the part we measured) or neutral explanations, there might be other unaccounted or unknown influences. These are unmeasured factors for which we can pose hypotheses for further research and data collection.

4.  **Random noise:** Alternatively, differences may simply be due to random noise, stochastic events, or measurement inaccuracies that obscure genuine patterns.
...
::: {.content-visible when-format="html"}
![Slide 47](images/BDC334-047.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-047.jpeg}
\caption*{Slide 47}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 48](images/BDC334-048.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-048.jpeg}
\caption*{Slide 48}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 49](images/BDC334-049.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-049.jpeg}
\caption*{Slide 49}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 50](images/BDC334-050.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-050.jpeg}
\caption*{Slide 50}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 51](images/BDC334-051.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-051.jpeg}
\caption*{Slide 51}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 53](images/BDC334-053.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-053.jpeg}
\caption*{Slide 53}
\end{figure}
:::
...
1.  Find the difference in $x$ between $Q$ and $P$: $Q_1 - P_1$.
2.  Find the difference in $y$ between $Q$ and $P$: $Q_2 - P_2$.
3.  Square both differences: $(Q_1 - P_1)^2 + (Q_2 - P_2)^2$.
4.  Take the square root: $\sqrt{(Q_1 - P_1)^2 + (Q_2 - P_2)^2}$.
...
::: {.content-visible when-format="html"}
![Slide 54](images/BDC334-054.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-054.jpeg}
\caption*{Slide 54}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 55](images/BDC334-055.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-055.jpeg}
\caption*{Slide 55}
\end{figure}
:::
...
If you had more dimensions, you’d follow the same procedure, adding more squared differences and including them under the square root (Slide 55).
...
::: {.content-visible when-format="html"}
![Slide 56](images/BDC334-056.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-056.jpeg}
\caption*{Slide 56}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 57](images/BDC334-057.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-057.jpeg}
\caption*{Slide 57}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 59](images/BDC334-059.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-059.jpeg}
\caption*{Slide 59}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 60](images/BDC334-060.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-060.jpeg}
\caption*{Slide 60}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 61](images/BDC334-061.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-061.jpeg}
\caption*{Slide 61}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 62](images/BDC334-062.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-062.jpeg}
\caption*{Slide 62}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 63](images/BDC334-063.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-063.jpeg}
\caption*{Slide 63}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 64](images/BDC334-064.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-064.jpeg}
\caption*{Slide 64}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 65](images/BDC334-065.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-065.jpeg}
\caption*{Slide 65}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 66](images/BDC334-066.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-066.jpeg}
\caption*{Slide 66}
\end{figure}
:::
...
1.  **It is square.** There are as many columns as rows — $58$ in this example.
2.  **It is symmetrical.** The upper triangle is a mirror image of the lower triangle.
3.  **There is a zero diagonal.** Each site compared to itself contains a zero, because there is no difference.
...
::: {.content-visible when-format="html"}
![Slide 67](images/BDC334-067.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-067.jpeg}
\caption*{Slide 67}
\end{figure}
:::
...
Accompany your reading of this chapter with the material presented in [Lab 4](Lab-04-biodiversity).
:::

# Lecture 6a {.unnumbered}
...
::: {.content-visible when-format="html"}
![Slide 69](images/BDC334-069.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-069.jpeg}
\caption*{Slide 69}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 70](images/BDC334-070.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-070.jpeg}
\caption*{Slide 70}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 71](images/BDC334-071.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-071.jpeg}
\caption*{Slide 71}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 72](images/BDC334-072.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-072.jpeg}
\caption*{Slide 72}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 73](images/BDC334-073.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-073.jpeg}
\caption*{Slide 73}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 74](images/BDC334-074.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-074.jpeg}
\caption*{Slide 74}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 75](images/BDC334-075.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-075.jpeg}
\caption*{Slide 75}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 76](images/BDC334-076.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-076.jpeg}
\caption*{Slide 76}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 77](images/BDC334-077.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-077.jpeg}
\caption*{Slide 77}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 78](images/BDC334-078.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-078.jpeg}
\caption*{Slide 78}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 79](images/BDC334-079.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-079.jpeg}
\caption*{Slide 79}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 80](images/BDC334-080.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-080.jpeg}
\caption*{Slide 80}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 81](images/BDC334-081.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-081.jpeg}
\caption*{Slide 81}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 82](images/BDC334-082.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-082.jpeg}
\caption*{Slide 82}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 83](images/BDC334-083.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-083.jpeg}
\caption*{Slide 83}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 84](images/BDC334-084.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-084.jpeg}
\caption*{Slide 84}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 85](images/BDC334-085.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-085.jpeg}
\caption*{Slide 85}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 86](images/BDC334-086.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-086.jpeg}
\caption*{Slide 86}
\end{figure}
:::
...
::: {.content-visible when-format="html"}
![Slide 87](images/BDC334-087.jpeg)
:::

::: {.content-visible when-format="pdf"}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\linewidth]{images/BDC334-087.jpeg}
\caption*{Slide 87}
\end{figure}
:::
...
The upshot of this paper is a comprehensive estimate of what ecosystem services are worth globally: Table 2 quotes a total value of $\$33$ trillion \emph{US dollars} for global ecosystem services (in 1997), a staggering sum.
...
Their content is directly relevant to your assessment and your overall disciplinary knowledge. Mastery of these readings may be assessed in the class tests and the final examination. See the [2026 syllabus](BDC334_syllabus.qmd#class-tests) for the class-test dates and times.
