...
This lab translates the conceptual framework from [Lecture 6](Lec-06-unified-ecology.qmd) into executable analyses.

- Conceptual framing and workflow rationale: see [Why "Unified Ecology"](Lec-06-unified-ecology.qmd#sec-lec06-why) and [Integrated Workflow](Lec-06-unified-ecology.qmd#sec-lec06-workflow).
- Pattern-family logic and assumptions: see [Core Pattern Families](Lec-06-unified-ecology.qmd#sec-lec06-patterns), [Hypothesis-Testing Frame](Lec-06-unified-ecology.qmd#sec-lec06-testing), and [Common Failure Modes](Lec-06-unified-ecology.qmd#sec-lec06-fail).
...
Theory link: see [Distance-decay and ordination logic](Lec-06-unified-ecology.qmd#sec-lec06-ordination) and [Hypothesis-Testing Frame](Lec-06-unified-ecology.qmd#sec-lec06-testing) in [Lecture 6](Lec-06-unified-ecology.qmd).
