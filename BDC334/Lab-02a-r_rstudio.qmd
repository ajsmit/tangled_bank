...
-   All course data files -- [`data folder`](https://drive.google.com/drive/folders/17wOshp348ZWikPPTyt4fqrKY2OmaV0FR?usp=sharing)
:::
...
5.  All data files for this course are available in the main [`data`](../data/BDC334/) folder. You can access individual files as needed throughout the course.
...
Please see [2. Rmarkdown and Quarto](../BCB744/intro_r/02-quarto.qmd) in BCB744.
