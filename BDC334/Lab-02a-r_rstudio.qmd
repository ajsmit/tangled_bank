...
-   BDC334 data archive -- [`BDC334_data.zip`](../data/BDC334_data.zip)
:::
...
5.  Download the file [`BDC334_data.zip`](../data/BDC334_data.zip) and unzip it into the folder where you created your project. This will create a new folder called `BDC334_data` in your project folder, which contains some data files that we will use later in the course.
