...
Now we turn to colour. This is not decoration. Colour tells the reader whether values differ by category, by magnitude, or by deviation from a midpoint. Used well, it makes a figure easier to read. Used badly, it lies.
