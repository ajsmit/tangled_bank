...
# What Will go Wrong, and Why That's Useful
...
::: {.callout-note appearance="simple"}
## I'm assuming (but should probably tell you)
...
Note that for the Natural Earth data the coordinate reference system (CRS) is **longitude / latitude in degrees**, and it is stored as [WGS84](https://epsg.io/4326). This is the World Geodetic System 1984 commonly used in most GPS devices. The default unit of this CRS is in degrees longitude and latitude.
...
```{r fig-ggplot}
#| fig-cap: "World map in WGS84 using Natural Earth countries."
#| eval: true
ggplot() +
...
#| fig-cap: "Natural Earth projection centred on 170E showing anti-meridian artefacts."
#| eval: true
...
#| fig-cap: "Natural Earth projection after anti-meridian repair."
#| eval: true
#| warning: false
...
#| fig-cap: "Oceania subset from the repaired world map."
#| eval: true
...
## Advanced pattern (recognition > memorisation)
...
#| fig-cap: "Southwest Pacific regions dissolved using UN classifications."
#| eval: true
#| warning: false
library(countrycode)
...
#| fig-cap: "Data-derived bounding box used to crop the Southwest Pacific map."
#| eval: true
#| echo: true
#| warning: false
...
#| fig-cap: "World map windowed by transformed bounding box coordinates."
#| eval: true
...
## Pitfall: correct can still be confusing
...
```{r fig-ggplot-2}
#| fig-cap: "Natural Earth map with projected graticule via coord_sf."
#| eval: true
ggplot() +
  geom_sf(data = world_1, colour = "black", fill = "grey70") +
  coord_sf(xlim = bbox_trans_coord[,'X'], ylim = bbox_trans_coord[,'Y'],
...
```{r fig-ggplot-3}
#| fig-cap: "Fiji region with earthquake points sized and coloured by magnitude."
#| eval: true
#| echo: true
ggplot() +
  geom_sf(data = sw_pacific_cropped, colour = "black", fill = "grey70") +
...
Now I apply a more appropriate CRS to the map. This is the **WGS 84 / NIWA Albers** projection ([EPSG:9191](https://epsg.io/9191)), which is designed for the southwestern Pacific and the Southern Ocean around New Zealand.
...
#| fig-cap: "Fiji region in NIWA Albers projection with earthquake magnitudes."
#| eval: true
#| echo: true
#| fig-width: 12
#| dpi: 300
...
This chapter is about **reasoning with spatial data**. You learned to:
...
# CRS and Spatial Workflow Decision Tree
