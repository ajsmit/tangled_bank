...
Over the module of this workshop, you have learned not just *how* to use R, but *how to think* in a tidy, reproducible, and analytical way. These skills are foundational for all subsequent assessments and for the Biostatistics component that follows.
