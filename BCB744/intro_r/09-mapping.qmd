...
This is why `coord_equal()` becomes important (@sec-coordsequal). It preserves a 1:1 relationship between units on the axes so the geometry is not subtly stretched as in @fig-borders.
