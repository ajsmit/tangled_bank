...
```{r code-faceting-opts, echo=FALSE}
...
```{r fig-facet-1, fig.cap="Simple faceted figure showing a linear model applied to each diet."}
# Load data
...
```{r fig-facet-line, fig.cap="Line graph for the progression of chicken weights (g) over time (days) based on four different diets."}
...
```{r fig-facet-lm, fig.cap="Linear models for the progression of chicken weights (g) over time (days) based on four different diets."}
...
```{r fig-facet-hist, message=FALSE, fig.cap="Histogram showing final chicken weights (g) by diet."}
...
```{r fig-facet-box, fig.cap="Violin plot showing the distribution of final chicken weights (g) by diet."}
# Note that we are using 'ChickLast', not 'ChickWeight'
...
```{r fig-facet-grid, warning=FALSE, message=FALSE, fig.cap="All four of our figures gridded together with an automagically created common legend."}
