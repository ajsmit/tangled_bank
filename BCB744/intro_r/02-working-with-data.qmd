...
An **RStudio Project** defines a directory as the root of an analysis and sets it as the working directory whenever the project is opened. This has three consequences that are foundational for this module:
...
This is why projects are treated as non-negotiable infrastructure in this module. They make file paths explicit, stable, and inspectable.
