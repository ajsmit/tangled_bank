...
* `data/BCB744/kelp.csv` refers to a file called `kelp.csv` inside the `data/BCB744` sub-directory.
...
* `../data/BCB744/kelp.csv` means “go up one directory, then into `data/BCB744`”.
...
* `BCB744/`
  ...
  * `data/BCB744/` ... (raw or cleaned data)
  * `scripts/` ... (R scripts)
