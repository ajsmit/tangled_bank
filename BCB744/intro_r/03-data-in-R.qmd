...
* Unlike a dataframe, a tibble never automatically converts strings to factors or changes column names, which can help avoid unexpected behaviour when working with the data.
