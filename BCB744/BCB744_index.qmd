...
::: {.tb-course-hero}
[BCB744 · Honours core]{.tb-course-eyebrow}

# Introduction to R & Biostatistics {.tb-course-title}

[Learn to organise, visualise, and analyse biological data in R, then use
statistical reasoning to make defensible inferences from ecological and
environmental evidence.]{.tb-course-lede}

::: {.tb-course-actions}
[Start with R and RStudio](intro_r/01-RStudio.qmd){.tb-action .tb-action-primary}
[View the module schedule](#venue-timetable-and-content){.tb-action .tb-action-secondary}
:::
:::
...
Reproducible analysis and statistical inference
:::

::: {.tb-course-fact}
[Structure]{.tb-course-fact-label}

Two intensive teaching blocks and a portfolio
:::

::: {.tb-course-fact}
[Tools]{.tb-course-fact-label}

R, RStudio, the tidyverse, and Quarto
:::
:::

::: {.tb-teaching .tb-learning-objectives}

- Work confidently with R, RStudio, and reproducible Quarto documents.
- Clean, transform, visualise, and describe biological data.
- Select and apply common inferential tests and regression methods.
- Interpret statistical output and communicate evidence clearly.
:::
...
Begin with [R and RStudio](intro_r/01-RStudio.qmd), then learn how data, code,
projects, and Quarto documents fit together.
:::
...
Work through data structures, graphics, mapping, tidy data, and reproducible
analysis while adding each day’s work to your progress portfolio.
:::
...
Move from distributions and uncertainty to inference, standard tests,
regression, diagnostics, and evidence-based scientific conclusions.
:::
:::
...
-   **Introduction to R**: From 2 to 13 February 2026, 9:00 to approx. 15- or 16:00.
-   **Data Collection Field Trip**: From 13 to 17 March 2026.
-   [**Biostatistics**: From 30 March to 7 April 2026, 9:00 to approx. 15- or 16:00.]{.my-highlight}
-   **Important links:**
    -   [Course Synthesis](../cheatsheets/cheatsheet-course-synthesis.pdf) for BCB744 Biostatistics
    -   [Statistics Method Cheatsheet](../cheatsheets/cheatsheet-inferential-stats.pdf)
    -   [Study Design Cheatsheet](../cheatsheets/cheatsheet-study-design.pdf)
...
| :--- | :------ | :---------------------------------------------------------------------------------------------- | :--------- | :------------------------------------------ | :--------------- |
|      |         | **INTRODUCTION TO R**                                                                          |            |                                            |                  |
| Wk6  | L1 (PM) | About the Module                                                                               | 2 Feb 26   | [Task A](tasks/BCB744_Task_A.qmd)         | 4 Feb 26         |
|      |         | [1. R and RStudio](intro_r/01-RStudio.qmd)                                                    |            |                                            |                  |
|      |         | [2. Working With Data and Code](intro_r/02-working-with-data.qmd)                             |            |                                            |                  |
|      |         | [3. R Markdown and Quarto](intro_r/03-quarto.qmd)                                              |            |                                            |                  |
|      | L2 (AM) | [4. Data Classes and Structures in R](intro_r/04-data-in-R.qmd)                               | 3 Feb 26   | [Task A](tasks/BCB744_Task_A.qmd)         | 4 Feb 26         |
|      |         | [5. R Workflows](intro_r/05-workflow.qmd)                                                     |            |                                            |                  |
|      | L3      | [6. Graphics With **ggplot2**](intro_r/06-graphics.qmd)                                       | 4 Feb 26   | [Task B](tasks/BCB744_Task_B.qmd)         | 6 Feb 26         |
|      |         | [7. Faceting Figures](intro_r/07-faceting.qmd)                                                |            |                                            |                  |
|      |         | [8. Brewing Colours](intro_r/08-brewing.qmd)                                                  |            |                                            |                  |
|      | L4      | [9. Mapping With **ggplot2**](intro_r/09-mapping.qmd)                                         | 6 Feb 26   | [Task C](tasks/BCB744_Task_C.qmd)         | 9 Feb 26         |
|      |         | [10. Mapping With Style](intro_r/10-mapping_style.qmd)                                        |            |                                            |                  |
|      |         | [11. Mapping With Natural Earth and the **sf** Package](intro_r/11-mapping_rnaturalearth.qmd) |            |                                            |                  |
|      | Self    | [12. The Fiji Earthquake Data](intro_r/12-mapping_quakes.qmd)                                 |            | [Bonus Task](tasks/BCB744_Task_Bonus.qmd) | 20 Feb 26        |
| Wk7  | L5      | [13. Tidy Data](intro_r/13-tidy.qmd)                                                          | 9 Feb 26   | [Task D](tasks/BCB744_Task_D.qmd)         | 11 Feb 26        |
|      |         | [14. Tidier Data](intro_r/14-tidier.qmd)                                                      |            |                                            |                  |
|      |         | [15. Tidiest Data](intro_r/15-tidiest.qmd)                                                    |            |                                            |                  |
|      | L6      | [16. Synthesis](intro_r/16-recap.qmd)                                                          | 11 Feb 26  |                                            |                  |
|      |         | [**Test 1: Intro R Theory Test**]{.my-highlight}                                               | 13 Feb 26  |                                            | 13 Feb 26        |
|      |         | **BIOSTATISTICS**                                                                              |            |                                              |                  |
| Wk14 | L1      | [1. The Statistical Landscape](basic_stats/01-statistical-landscape.qmd)                       | 30 Mar 26  |                                              |                  |
|      |         | [2. Summarising Biological Data](basic_stats/02-summarise-and-describe.qmd)                    |            | [SA 2-1](basic_stats/02-summarise-and-describe.qmd#self-assessment-task-2-1), [2-2](basic_stats/02-summarise-and-describe.qmd#self-assessment-task-2-2), [2-3](basic_stats/02-summarise-and-describe.qmd#self-assessment-task-2-3), [2-4](basic_stats/02-summarise-and-describe.qmd#self-assessment-task-2-4), [2-5](basic_stats/02-summarise-and-describe.qmd#self-assessment-task-2-5), [2-6](basic_stats/02-summarise-and-describe.qmd#self-assessment-task-2-6), [2-7](basic_stats/02-summarise-and-describe.qmd#self-assessment-task-2-7) | 31 Mar 26        |
|      |         | [3. Visualising Data](basic_stats/03-visualise.qmd)                                            |            | [SA 3-1](basic_stats/03-visualise.qmd#self-assessment-task-3-1)                                | 31 Mar 26        |
...
|      |         | [6. Raw-Data Assumptions and Transformations](basic_stats/06-assumptions-and-transformations.qmd) |            |                                              |                  |
|      | L2      | [7. Inferences About One or Two Populations](basic_stats/07-t_tests.qmd)                       | 31 Mar 26  | [SA 7-1](basic_stats/07-t_tests.qmd#self-assessment-task-7-1), [SA 7-2](basic_stats/07-t_tests.qmd#self-assessment-task-7-2)                                  | 1 Apr 26         |
|      |         | [8. Analysis of Variance (ANOVA)](basic_stats/08-anova.qmd)                                    |            | [SA 8-1](basic_stats/08-anova.qmd#self-assessment-task-8-1), [8-2](basic_stats/08-anova.qmd#self-assessment-task-8-2), [8-3](basic_stats/08-anova.qmd#self-assessment-task-8-3), [8-4](basic_stats/08-anova.qmd#self-assessment-task-8-4), [8-5](basic_stats/08-anova.qmd#self-assessment-task-8-5), [8-6](basic_stats/08-anova.qmd#self-assessment-task-8-6) | 1 Apr 26         |
|      |         | [9. Correlation and Association](basic_stats/09-correlation-and-association.qmd)               |            | [SA 9-1](basic_stats/09-correlation-and-association.qmd#self-assessment-task-9-1), [SA 9-2](basic_stats/09-correlation-and-association.qmd#self-assessment-task-9-2)              | 1 Apr 26         |
|      |         | [10. Finding Your Way on the Statistical Landscape](basic_stats/10-test-selection.qmd)                               |            |                                              |                  |
|      | L3      | [11. Residuals and Model-Based Diagnostics](basic_stats/11-residuals-and-model-based-diagnostics.qmd) | 1 Apr 26   |                                              |                  |
|      |         | [12. Simple Linear Regression](basic_stats/12-simple-linear-regression.qmd)                    |            | [SA 12-1](basic_stats/12-simple-linear-regression.qmd#self-assessment-task-12-1), [12-2](basic_stats/12-simple-linear-regression.qmd#self-assessment-task-12-2) | 2 Apr 26         |
|      |         | [13. Polynomial Regression](basic_stats/13-polynomial-regression.qmd)                          |            |                                              |                  |
|      | L4      | [14. Multiple Regression and Model Specification](basic_stats/14-multiple-regression-and-model-specification.qmd) | 2 Apr 26   |                                              |                  |
|      |         | [15. Interaction Effects](basic_stats/15-interaction-effects.qmd)                              |            |                                              |                  |
|      | SS      | [16. Collinearity, Confounding, and Measurement Error](basic_stats/16-collinearity-confounding-measurement-error.qmd) | --         |                                              |                  |
|      | SS      | [17. Model Checking and Evaluation](basic_stats/17-model-checking-and-evaluation.qmd)          | --         |                                              |                  |
|      | SS      | [18. Pseudoreplication](basic_stats/18-pseudoreplication.qmd)                                  | --         |                                              |                  |
|      | SS      | [19. Dependence and Mixed Models](basic_stats/19-dependence-and-mixed-models.qmd)              | --         |                                              |                  |
|      | SS      | [20. Generalised Linear Models](basic_stats/20-generalised-linear-models.qmd)                  | --         |                                              |                  |
|      | SS      | [21. Generalised Additive Models](basic_stats/21-generalised-additive-models.qmd)              | --         |                                              |                  |
|      | SS      | [22. Nonlinear Regression](basic_stats/22-nonlinear-regression.qmd)                            | --         |                                              |                  |
|      | SS      | [23. Quantile Regression](basic_stats/23-quantile-regression.qmd)                              | --         |                                              |                  |
|      | SS      | [24. Prediction and Explanation](basic_stats/24-prediction-and-explanation.qmd)                | --         |                                              |                  |
|      | SS      | [25. Regularisation](basic_stats/25-regularisation.qmd)                                        | --         |                                              |                  |
| Wk15 | L5      | Revision and test preparation                                                                  | 7 Apr 26   |                                              |                  |
...
The approach taken in this module is not dissimilar from a module in Data Science. However, in this module, we will not do data science, but we will use R to actually **do** science. There is a difference! Any scientist that can use R is also ideally equipped to be a data scientist, and some people who have completed this module actually do just that. The difference between the two ideas, philosophies, and careers is provided in the box immediately below.
...
The biostatistics material is now organised into two linked layers:

-   **Core taught chapters** These are the chapters taught directly in the block and assessed most explicitly in the module timetable. They move from statistical thinking and exploratory data analysis through inference, standard tests, and introductory regression.
-   **Extended reading chapters** These continue the same framework into model building, interactions, collinearity, confounding, diagnostics, dependence, and reproducible workflow. They support stronger project work and prepare you for more advanced analysis beyond the taught block.

The current core taught sequence is:
...
4. [Distributions, Sampling, and Uncertainty](basic_stats/04-distributions-sampling-uncertainty.qmd)
5. [Statistical Inference](basic_stats/05-inference.qmd)
6. [Assumptions and Transformations](basic_stats/06-assumptions-and-transformations.qmd)
7. [*t*-Tests](basic_stats/07-t_tests.qmd)
8. [ANOVA](basic_stats/08-anova.qmd)
...
Extended reading currently continues with:

-   [Pseudoreplication](basic_stats/18-pseudoreplication.qmd)
-   [Dependence and Mixed Models](basic_stats/19-dependence-and-mixed-models.qmd)
-   [Generalised Linear Models](basic_stats/20-generalised-linear-models.qmd)
-   [Generalised Additive Models](basic_stats/21-generalised-additive-models.qmd)
-   [Nonlinear Regression](basic_stats/22-nonlinear-regression.qmd)
-   [Quantile Regression](basic_stats/23-quantile-regression.qmd)
-   [Prediction and Explanation](basic_stats/24-prediction-and-explanation.qmd)
-   [Regularisation](basic_stats/25-regularisation.qmd)
-   [Reproducible Workflow](basic_stats/26-reproducible-workflow.qmd)
::::
...
-   Interpret the outcomes of these analyses and use them to probabilistically make inferences about the scientific enquiries
-   Communicate the findings in written and oral form
...
| **Introduction to R** |  |  |
| Progress Portfolio |  | 15 |
| Self-Assessment Tasks A--D (Random penalty)[^1] |  | (max. -10) |
| [Intro R Theory Test]{.my-highlight} |  | 35 |
| **Biostatistics** |  |  |
| Progress Portfolio |  | 15 |
| Self-Assessment Tasks (Random penalty) |  | (max. -10) |
...
Starting 1 April 2026. This is similar to that of Introduction to R, with one difference: The Portfolio will now contain the Self-Assessment Tasks --- *i.e.*, you will submit one document the day after the lecture, at 8:00, and it will be comprised of two sections:

- **Section A:** Self-Assessment Tasks (if available for the lectures/days), *and*
- **Section B:** The "Do this now!" exercises, *as well as* the general Portfolio material --- see Introduction to R, above, for details w.r.t. the expectations of the Portfolio.

So, you will submit only one document each day, inclusive of both components.
...
-   Code formatting, structure, and correctness (50%):
    ...
    -   Application of [the tidyverse style guide](https://style.tidyverse.org/), *e.g.* spaces around `<-`, after `#`, after `, `, etc.
...
### Late Submission of CA {#late-submission-of-ca}
...
## Module Structure and Philosophy

The biostatistics portion of this module is designed to follow a logical progression, building from foundational concepts to advanced applications in ecological inference. The sequence is structured into distinct phases:

*   **Phase 1 — Statistical Thinking and Data Foundations:** Begins with scientific reasoning, exploratory data analysis, data visualisation, distributions, sampling variation, and uncertainty.
*   **Phase 2 — Core Hypothesis Tests:** Covers inference, assumptions, transformations, *t*-tests, ANOVA, correlation, and practical guidance on choosing among standard methods.
*   **Phase 3 — Regression and Model Building:** Introduces simple and multiple regression, model specification, interactions, and the interpretation challenges created by collinearity, confounding, and measurement error.
*   **Phase 4 — Evaluation and Extension:** Moves into model checking, model comparison, and then into extended reading on pseudoreplication, dependence, mixed models, and reproducible workflow.
*   **Phase 3 — Model Construction:** Moves into the art and science of building models, covering how to specify models that reflect biological hypotheses, account for causal structure, and test for interaction effects.
*   **Phase 4 — Model Evaluation:** Once models are built, this phase provides a principled framework for comparing them using information criteria, while also introducing the dangers of overfitting and the importance of assessing a model's ability to generalise.
*   **Phase 5 — Data Structure:** Broadens the concept of independence to address inherent data structures like temporal, spatial, and hierarchical dependencies.
*   **Phase 6 — The Solution:** Mixed-effects models are presented as the powerful tool for correctly analysing the structured data common in ecology.
*   **Phase 7 — Synthesis and Practice:** The final phase synthesizes these concepts by focusing on the critical distinction between prediction and explanation, and culminates in a guide to implementing a transparent and reproducible modeling workflow.
