...
* **Intro to R**: 3 - 7 February 2025
* **Biostatistics**: 31 March - 4 April 2025 (during the mid-semester break of Semester 1)
...
**Dr. Bryan Maritz**: Room 4.105, Department of Biodiversity & Conservation Biology
...
**TBA**: Department of Biodiversity & Conservation Biology, ???????@myuwc.ac.za
...
|-------|-----------|-------------------------------------------------------------------------------------------|---------------|---------------------------------------------------------------------------------------|-------------------|
|       |           | **INTRO R**                                                                               |               |                                                                                       |                   |
| Wk1   | L1        | Introduction                                                                              | 3 Feb 25      | Task A                                                                                | 4 Feb 25          |
...
|       | L2        | [4. Graphics with ggplot2](intro_r/04-graphics.html)                                      | 4 Feb 25      | Task B                                                                                | 5 Feb 25          |
|       |           | [5. Faceting figures](intro_r/05-faceting.html)                                           |               |                                                                                       |                   |
|       | L3        | [6. Brewing colours](intro_r/06-brewing.html)                                             | 5 Feb 25      | Task C                                                                                | 6 Feb 25          |
...
|       | Self      | [10. The Fiji Earthquake data](intro_r/10-mapping_quakes.html)                            |               | Bonus Task                                                                            | 31 Mar 25         |                                                                                      |                   |
|       | L4        | [11. Tidy data](intro_r/11-tidy.html)                                                     | 6 Feb 25      | Task D                                                                                | 7 Feb 25          |
...
## Core Theoretical Content and Philosophical Framework
