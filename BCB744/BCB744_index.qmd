...
-   [Pseudoreplication](basic_stats/16-pseudoreplication.qmd)
-   [Dependence and Mixed Models](basic_stats/17-dependence-and-mixed-models.qmd)
-   [Generalised Linear Models](basic_stats/18-generalised-linear-models.qmd)
-   [Nonlinear and Flexible Regression](basic_stats/19-nonlinear-and-flexible-regression.qmd)
-   [Prediction, Explanation, and Regularisation](basic_stats/20-prediction-explanation-and-regularisation.qmd)
-   [Reproducible Workflow](basic_stats/21-reproducible-workflow.qmd)
::::
