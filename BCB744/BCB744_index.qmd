...
Jesse Phillips---Department of Biodiversity & Conservation Biology, jessephillips11.jp@gmail.com
...
## Scientists and Data Scientists {#sec-datascience}

A **Scientist** able to apply their intermediate to advanced R skills is by default also a 'Data Scientist'. The opposite is generally not true: Data Scientists are not 'actual' Scientists -- at least not after having completed 'traditional' courses in data science.

**Science** refers to the traditional scientific method of conducting research, where hypotheses are proposed, experiments are designed and conducted to test these hypotheses, and data are collected and analysed to draw conclusions. The aim of Science is to generate *new knowledge and understanding* of the natural world. A Scientist will typically be well-equipped to work through all of these steps.

**Data Science**, on the other hand, involves the use of computational and statistical tools to extract knowledge and insights from data. These datasets typically already exist because someone (companies, industries, NGOs, etc.) collected it. Data Science focuses on analysing large and complex datasets to uncover patterns, trends, and relationships that can be used to inform decision-making. The Data Scientist is not typically involved in generating the data from scratch.

While Science and Data Science share some commonalities, such as the use of data and statistics, they differ in several key ways:
...
-   **Goals** Science aims to generate new knowledge and understanding of the natural world, while Data Science aims to uncover insights and make predictions based on existing data.

-   **Methods** Science involves conducting experiments, collecting and analysing data, and drawing conclusions based on the results. Data Science involves using statistical and computational tools to analyse data and uncover patterns and relationships.
...
In summary, Science and Data Science differ in their approach, goals, methods, and context, but both are valuable for advancing knowledge and understanding of the world around us.
:::
...
|-------|-----------|-------------------------------------------------------------------------------------------|---------------|-----------------------------------------------------------------------|-------------------|
|       |           | **INTRO R**                                                                               |               |                                                                       |                   |
| Wk1   | L1        | Introduction                                                                              | 7 Feb '23     |                                                                       | 8 Feb '23         |
|       |           | [1. R and RStudio](intro_r/01-RStudio.html)                                               |               | Task A                                                                | 8 Feb '23         |
|       |           | [2. Working with data and code](intro_r/02-working-with-data.html)                        |               |                                                                       |                   |
|       |           | [3. R workflows](intro_r/03-workflow.html)                                                |               | Task B                                                                | 8 Feb '23         |
|       | L2        | [4. Graphics with ggplot2](intro_r/04-graphics.html)                                      | 8 Feb '23     | Task C                                                                | 9 Feb '23         |
|       |           | [5. Faceting figures](intro_r/05-faceting.html)                                           |               | Task D                                                                | 9 Feb '23         |
|       |           | [6. Brewing colours](intro_r/06-brewing.html)                                             |               | Task E                                                                | 9 Feb '23         |
|       | L3        | [7. Mapping with ggplot2](intro_r/07-mapping.html)                                        | 9 Feb '23     |                                                                       |                   |
|       |           | [8. Mapping with style](intro_r/08-mapping_style.html)                                    |               |                                                                       |                   |
|       |           | [9. Mapping with Natural Earth and the sf package](intro_r/09-mapping_rnaturalearth.html) |               | Task F                                                                | 10 Feb '23        | 
|       |           |                                                                                           |               | Bonus Task                                                            | 31 Mar '23        |
| Wk3   | L4        | [10. Tidy data](intro_r/11-tidy.html)                                                     | 20 Feb '23    | Task G                                                                | 1 Mar '23         |
|       |           | [11. Tidier data](intro_r/12-tidier.html)                                                 |               |                                                                       |                   |
|       |           | [12. Tidiest data](intro_r/13-tidiest.html)                                               |               | [Summative Task 1](../assessments/Intro-R_CA_Summative%20Tasks.Rmd)   | 1 Mar '23         |
|       | L5        | Recap                                                                                     | 20 Feb '23    |                                                                       |                   |
| Wk5   |           |                                                                                           | 6 Mar '23     | [Intro R Assessment](../assessments/Intro-R_CA_Assessment.html)       | 6 Mar '23         |
|       |           | **BIOSTATISTICS**                                                                         |               |                                                                       |                   |
| Wk9   | L1        | [1. Data classes and structures in R](basic_stats/01-data-in-R.qmd)                       | 3 Apr '23     | Task A                                                                | 5 Apr '23         |
|       |           | [2. Exploring with summaries and descriptions](basic_stats/02-summarise-and-describe.qmd) |               | Task B                                                                | 5 Apr '23         |
|       |           | [3. Exploring with figures](basic_stats/03-visualise.qmd)                                 |               | Task C                                                                | 5 Apr '23         |
|       | L2        | [4. Data distributions](basic_stats/04-distributions.qmd)                                 | 5 Apr '23     |                                                                       |                   |
|       |           | [5. Statistical inference and hypothesis testing](basic_stats/05-inference.qmd)           |               | Task D                                                                | 6 Apr '23         |
|       |           | [6. Data transformations](basic_stats/06-assumptions.qmd)                                 |               | [Summative Task 2](../assessments/BCB744_Summative_Task_2_2023.Rmd)   | 12 Apr '23        |
|       |           | [7. Inferences about one or two populations](basic_stats/07-t_tests.qmd)                  |               | Task E                                                                | 6 Apr '23         |
|       |           | [8. Analysis of Variance (ANOVA)](basic_stats/08-anova.qmd)                               |               | Task F                                                                | 6 Apr '23         |
|       | L3        | [9. Simple linear regressions](basic_stats/09-regressions.qmd)                            | 6 Apr '23     | Task G                                                                | 7 Apr '23         |
|       |           | [10. Correlations](basic_stats/10-correlations.qmd)                                       |               | Task H                                                                | 7 Apr '23         |
|       |           | [11. Non-Parametric statistics](basic_stats/11-glance.qmd)                                |               |                                                                       | 7 Apr '23         |
|       | L4        | [12. Confidence intervals](basic_stats/12-confidence.qmd)                                 | 6 Apr '23     |                                                                       |                   |
| Wk11  |           |                                                                                           | May '23       | [Final Integrative Assessment](../assessments/Final_Integrative_Assessment_2023.qmd)| May '23           |
...
- Understand the types of data and data distributions that biologists and ecologists will most often encounter
- Understand and be able to execute a full range of the most frequently used inferential statistics
- Use the R software and associated packages to undertake an array of analyses required for basic statistics in the biological and ecological sciences
- Interpret the outcomes of the above analyses and use it to probabilistically make inferences about the scientific enquiries
...
You should have a moderate numerical literacy, but prior programming experience is not required. In all sciences, practical problem solving skills and a tenacity for challenges are crucial for success. All scientific disciplines are constantly evolving and presents new and complex problems that require creative and innovative solutions. A scientist that's agile and adaptive in their approach to solving challenges in biological datasets must have the ability to break down complex problems into smaller parts and approach them systematically. They must also be able to identify and overcome roadblocks, and be persistent in their efforts to find a solution. Having strong problem-solving skills and a tenacity for challenges allow scientists to effectively analyse data, extract insights, and communicate their findings in a meaningful way. This not only helps organisations make informed decisions, but also drives progress and innovation in the field.
...
Collaborative learning provides an opportunity for students to work together and learn from each other, which can lead to a deeper understanding of the subject matter. Collaborating with classmates allows students to explore different perspectives and ideas, which can broaden their understanding and help them to see the subject matter from a new angle. This type of learning environment also fosters the development of important skills such as communication, teamwork, and leadership, which are essential for success in both academic and professional settings. Additionally, collaborative learning can create a sense of community and support among classmates, which can help students to feel more connected to their peers and to the university as a whole. Ultimately, it can enhance the university experience, foster a love of learning, and prepare students for success beyond the classroom.

Discuss the BCB744 Workshop activities with your peers as you work on them. Use also the WhatsApp group set up for the module for discussion purposes (I might assist via this medium if neccesary if your questions/comments have relevance to the whole class). A better option is to use [GitHub Issues](/quantecol/#help-via-bcb744-and-bcb743-issues-on-github). You will learn more in this module if you work with your friends than if you do not. Ask questions, answer questions, and share ideas liberally. Please identify your work partners by name on all assignments (if you decide to work in pairs).
