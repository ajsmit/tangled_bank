...
|      | L4      | [11. Simple Linear Regression](basic_stats/11-simple-linear-regression.qmd)                    | 2 Apr 26   | [Task H](tasks/BCB744_Task_H.qmd)         | 3 Apr 26         |
...
-   [Pseudoreplication](basic_stats/17-pseudoreplication.qmd)
-   [Dependence and Mixed Models](basic_stats/18-dependence-and-mixed-models.qmd)
-   [Generalised Linear Models](basic_stats/19-generalised-linear-models.qmd)
-   [Generalised Additive Models](basic_stats/20-generalised-additive-models.qmd)
-   [Nonlinear Regression](basic_stats/21-nonlinear-regression.qmd)
-   [Quantile Regression](basic_stats/22-quantile-regression.qmd)
-   [Prediction and Explanation](basic_stats/23-prediction-and-explanation.qmd)
-   [Regularisation](basic_stats/24-regularisation.qmd)
-   [Reproducible Workflow](basic_stats/25-reproducible-workflow.qmd)
::::
