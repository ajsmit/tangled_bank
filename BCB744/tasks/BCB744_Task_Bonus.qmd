...
```{r fig-library-tidyverse, echo=FALSE, warning=FALSE, message=FALSE, fig.width=6, fig.asp=0.65, out.width="80%", fig.align='center'}
#| fig-cap: "Southwest Pacific base map using Natural Earth projection."
library(tidyverse)
library(sf)
...
```{r fig-library-tidyverse-2, echo=TRUE, warning=FALSE, message=FALSE, fig.width=6, fig.asp=0.65, out.width="80%", fig.align='center'}
#| fig-cap: "Southwest Pacific base map for the Fiji earthquake task."
library(tidyverse)
library(sf)
library(rnaturalearth)
library(rnaturalearthdata)
...
```{r code-quakes-sf-trans-sub-quakes-sf-trans, echo=TRUE, warning=FALSE, message=FALSE, fig.width=6, fig.asp=0.65, out.width="80%", fig.align='center'}
# Filter the data
quakes_sf_trans_sub <- quakes_sf_trans |> # ✓
  filter(mag > quantile(mag, 0.75))

# Add the points
islands <- read.csv(here::here("data", "BCB744", "pacific_nations.csv")) # ✓
