...
I begin with a boxplot and jittered points so that the distribution within each diet is visible.
...
:::: {.callout-important}
## Do It Now!
a. Produce a `ggplot2` version of the Tukey result.
::::

:::: {.callout-note appearance="simple"}
## Self-Assessment Task G.3
