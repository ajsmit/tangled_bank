...
Although ANOVA is also a linear model with categorical predictors, this chapter keeps the discussion at the grouped-data level. The later regression chapters, especially [Chapter 11](11-simple-linear-regression.qmd) and [Chapter 13](13-multiple-regression-and-model-specification.qmd), make the linear-model connection explicit and introduce residual-based diagnostics in that context.
...
This chapter introduces interaction in ANOVA form only. [Chapter 14](14-interaction-effects.qmd) develops the interpretation of interactions in much more detail.
...
-   **ANCOVA** is a linear model with a factor and a continuous covariate. It belongs in [Chapter 13](13-multiple-regression-and-model-specification.qmd), where factors and covariates are treated within the same model.
-   **Repeated-measures, blocked, or within-individual designs** are dependence problems. Those belong in [Chapter 18](18-dependence-and-mixed-models.qmd).
