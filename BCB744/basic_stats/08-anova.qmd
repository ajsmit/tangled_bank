...
::: callout-important
## Task F
4. Look at the help file for the `TukeyHSD()` function to better understand what the output means.
...
6. Figure out a way to plot the Tukey HSD outcomes in **ggplot**.
...
::: callout-important
## Task F
12. Write out the hypotheses for this ANOVA.
13. What do you conclude from the above ANOVA?
:::
...
::: callout-important
## Task F
14. What question are we asking with the above line of code? What is the answer? Also, why did we wrap `Time` in `as.factor()`?
:::
...
::: callout-important
## Task F
15. How do these results differ from the previous set?
:::
...
::: callout-important
## Task F
16. Yikes! That's a massive amount of results. What does all of this mean, and why is it so verbose?
:::
