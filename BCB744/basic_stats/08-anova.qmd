...
When reporting a one-way ANOVA, state:

-   the response variable and grouping factor;
-   the ANOVA statistic and degrees of freedom;
-   the *p*-value;
-   the group means and their spread;
-   the main post-hoc result if a follow-up test was used.
