...
Two competing hypotheses about the data are set up at the onset of hypothesis testing: a **null hypothesis** (*H*~0~) and an **alternative hypothesis** (*H*~a~). The null hypothesis typically represents the *status quo* or a default assumption (a statement of no difference), while the alternative hypothesis represents a new, alternative explanation for the data. The alternative hypothesis is supported by biological or ecological reasoning about how an influential variable influences the system under study.

Hypothesis testing evaluates whether the observed data are consistent with a stated null model. It does not prove a hypothesis true; it asks whether the evidence is strong enough to reject the null in favour of an alternative explanation. In science, that process helps us discard weak explanations, retain those that remain plausible, and refine our models of the natural world. Scientific progress depends not on automatically “accepting” alternatives, but on subjecting explanations to repeated attempts at falsification and keeping only those that survive serious scrutiny.
