...
A **test statistic** is a numerical summary of the evidence in the sample. Different methods use different statistics: a *t*-test uses a *t* statistic, ANOVA uses an *F* statistic, correlation uses the correlation coefficients $r$, $\rho$, or $\tau$, and regression uses slopes, $R^2$, and related summaries.
