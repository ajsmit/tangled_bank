...
-   [Self-Assessment Task 12-1](#self-assessment-task-12-1)
-   [Self-Assessment Task 12-2](#self-assessment-task-12-2)
:::
...
The penguin model explained only about 30% of the variation in bill length. Explore whether restricting the data to one sex improves the fit:
...
Compare the $R^2$ and residual standard error from `mod_female` with the values from `mod1` (all Adelie penguins combined). Does splitting by sex change the picture? Run the same model for males and compare. What does this tell you about the usefulness of one-predictor models in biology?
:::
