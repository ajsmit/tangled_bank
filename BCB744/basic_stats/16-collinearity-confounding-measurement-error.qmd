...
The EDA already suggests a confounding structure. Temperature and nutrient concentration are strongly positively correlated ($r = 0.84$), and both appear positively related to algal abundance. That means a temperature-only model would be at risk of absorbing part of the nutrient effect.
