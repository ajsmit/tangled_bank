...
-   What pseudoreplication is
-   Why pseudoreplication invalidates inference
-   Common forms of pseudoreplication
-   How to identify the true experimental unit
...
Fish growth was compared between a treatment and control using replicate ponds as the experimental units. Multiple fish were sampled within each pond to estimate mean growth, but the pond rather than the individual fish was treated as the replicate in the analysis.

**Results**

Mean fish growth differed between treatment and control ponds only to the extent supported by variation among ponds. The analysis therefore assessed the treatment effect against the correct error term rather than against variation among subsampled fish within a pond.

**Discussion**

This distinction is critical because treating individual fish as replicates would have overstated the effective sample size and inflated confidence in the treatment effect. The design and analysis must therefore match the scale at which the treatment was applied.
:::
...
Insect abundance was assessed in replicate field plots to which treatment and control conditions were randomly assigned in an interspersed design. Sweep-net samples taken within each plot were used to characterise local abundance, but the plot was treated as the experimental unit in the analysis.

**Results**

Differences in insect abundance between treatment and control were evaluated among replicate plots, thereby separating treatment effects from background spatial heterogeneity within the field.

**Discussion**

This design avoids conflating treatment with spatial position. Had one half of the field been treated and the other half used as a control, any underlying environmental gradient could have been mistaken for an insecticide effect.
:::
...
The effect of nutrient addition on algal biomass was evaluated using replicate treatment and control lakes. Repeated measurements through time were collected within each lake, but the analysis explicitly recognised lake as the experimental unit and treated time as repeated sampling within units.
...
This approach prevents temporal pseudoreplication. Repeated monthly observations can improve description of within-lake dynamics, but they do not create additional independent replicates of a treatment applied to a single lake.
:::
...
Seasonal differences in algal biomass were assessed across replicated bay or year units so that season could be evaluated against independent replication rather than against repeated observations from a single time series. Weekly samples within each unit were treated as repeated observations rather than as independent replicates.

**Results**

Across the replicated bay or year units, summer algal biomass was higher than winter biomass only insofar as that difference was consistent among independent units. The seasonal contrast was therefore judged against among-unit variation, not against week-to-week fluctuation within a single annual record.

**Discussion**

Without such replication, an apparent seasonal difference could simply reflect the idiosyncrasies of one bay or one year. The lesson is that repeated sampling within a system refines description, but does not by itself justify inferential comparison among treatment or seasonal categories.
:::
