...
This chapter introduces the numerical summaries used at the start of that process. It focuses on measures of centre, measures of spread, and a small set of tools for inspecting the structure of a dataset. These summaries work alongside the figures in [Chapter 3](03-visualise.qmd) and the treatment of distributions and uncertainty in [Chapter 4](04-distributions-sampling-uncertainty.qmd).

# Key Concepts

This section defines the ideas that organise the rest of the chapter.
...
- **Centre and spread:** Most numerical summaries describe either where the data cluster or how widely they vary.
- **Distribution:** The shape of a distribution determines which summaries describe it well. Symmetric data and skewed data are not best summarised in the same way.
- **Grouped summaries:** Biological datasets often contain treatments, species, sites, or times. Summaries by group often reveal structure hidden in pooled data.
...
This section introduces the summaries used most often in EDA. They answer three basic questions: where is the centre of the data, how much do the values vary, and which summaries remain sensible when the data are skewed or contain outliers.
...
```{r fig-histos}
#| fig-cap: "Histograms for generated normal, right-skewed, left-skewed, and bimodal distributions."
#| fig-width: 5.5
#| fig-height: 4
