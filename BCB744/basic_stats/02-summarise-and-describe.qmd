...
As you can see, there are many option, you may use the one you least dislike. I will not be prescriptive or openly opinionated about it.
...
In this Chapter, we have explored the fundamental types of summary statistics typically encountered during EDA, the methods for calculating them. While these basic measures provide valuable insights and delving deeper into the data requires recognising the inherent grouping structures. By identifying how group membership influences measured variables, we can answer questions such as, "Are there differences in bill length, bill depth, flipper length, and body mass between species?", "Does the island where individuals were studied affect these variables?" Additionally or we might be interested in investigating the effects of sex and year. Numerous approaches can be taken to dissect this structured dataset, each shedding light on unique aspects of the data's structure, relationships.
