...
In this chapter we focus on the basic components of EDA, built around measures of central tendency (the **mean**, **median**, **mode**) and dispersion (*e.g.* **standard deviation**, **standard error**, **variance**, and **quantiles**). I advocate a workflow in which numerical summaries, graphical assessment [(Chapter 3)](03-visualise.qmd), and an understanding of distributions and uncertainty [(Chapter 4)](04-distributions-sampling-uncertainty.qmd) all precede formal inferential statistics.
...
-   **Parametric vs non-parametric tests** If the data exhibit normality and homoscedasticity, parametric tests may be appropriate (see [Chapter 7](07-t_tests.qmd)). However, if the data have high variability, violates the assumptions of parametric tests or non-parametric alternatives may be more suitable.
