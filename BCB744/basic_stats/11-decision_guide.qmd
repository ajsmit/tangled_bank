...
Selecting the appropriate inferential statistical method is important for correctly and accurately analysing the outcome of our sampling campaign or experimental treatment. The decision typically hinges on the **[type](../intro_r/03-data-in-R.qmd) and [distribution](04-distributions.qmd)** of our data, our **research question or [hypothesis](05-inference.qmd)**, and the **[assumptions](06-assumptions.qmd)** each test requires.
