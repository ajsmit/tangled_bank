...
Think of two biological variables you have measured or would expect to measure in your research. For each one, identify: (1) whether it is discrete or continuous, (2) what biological process generates it, (3) which distribution from this chapter most plausibly describes it, and (4) what would make that distribution choice wrong (*e.g.*, overdispersion, bounded range, always positive). Share your choices with a partner and see if you agree.
:::

::: {.callout-important appearance="default"}
## Do This Now!

Select your favourite three conitnuous variables in the BCB7342 field trip set of data. Assess your data's distribution, provide visual support, and discuss.
:::
