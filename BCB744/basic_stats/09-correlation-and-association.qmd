...
-   [Self-Assessment Task 9-1](#self-assessment-task-9-1)
-   [Self-Assessment Task 9-2](#self-assessment-task-9-2)
::: 
...
a. Body mass (g) and wing span (mm) in a sample of 120 birds — the scatterplot looks roughly linear.
b. Ecologist ranks 15 sites from least to most disturbed (1–15); another ecologist ranks the same 15 sites by species richness. The question is whether more disturbed sites tend to rank lower in diversity.
c. Sea surface temperature and chlorophyll-a concentration in a large oceanographic dataset — the relationship is clearly curvilinear (cooling increases phytoplankton).
d. For (c), does Spearman also have an advantage over Pearson when data are skewed?
e. A nutritionist scores diet quality on a 5-point ordinal scale and records BMI for 40 participants.
:::
