...
In @eq-interaction, the coefficient $\beta_3$ is the interaction term. It describes how the effect of one predictor changes as the other predictor changes. For novices, the key point is this: an interaction is not just a bigger model. It is a claim that one slope depends on another variable.
