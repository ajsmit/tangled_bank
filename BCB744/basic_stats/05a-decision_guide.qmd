---
author: "AJ Smit"
title: "5a. A quick guide to selecting the right test"
date: "`r Sys.Date()`"
...
A tabulated summary of these tests is included below. Refer to [11. Non-parametric statistical tests at a glance](11-glance.qmd) for information about non-parametric tests to use when assumptions fail.
