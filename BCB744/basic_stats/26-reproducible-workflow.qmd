...
Even this small example already illustrates that the table and figure are not separate objects made by hand. The figure in @fig-kelp-workflow is generated directly from the dataset by code embedded in the document.
