...
Through this exploration of **ggplot2**, we will gain a deeper understanding of the data by supplementing the analyses in [Chapter 2](02-summarise-and-describe.qmd) with figures to uncover hidden patterns, trends and to communicate our findings to others in a clear and compelling way.

Let us explore some figure types to use for statistical summaries. These figures can be used to accompany the statistics computed in [Chapter 2](02-summarise-and-describe.qmd). Note that I provide some basic examples of commonly encountered figure types only; this Chapter does not pretend to offer solutions for every conceivable problem about how to construct our figures. For such high-level information, or for even greater variety of figure types, please consult the following sources:
