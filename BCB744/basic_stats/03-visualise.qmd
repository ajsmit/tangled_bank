...
Exploratory data analysis (EDA) is a first, important step in most, if not all, biological, ecological studies and graphs are an essential tool for exploring, visualising, and communicating complex data. Among the most powerful, versatile graphing tools available to us is [**ggplot2**](https://ggplot2.tidyverse.org/). It provides an extensive range of graph types that can be customised to meet the needs of any analysis.
