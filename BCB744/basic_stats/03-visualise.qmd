...
Retrieve [these data](../../data/random_not.csv) and calculate the mean and standard deviation of the variables.
...
fwrite(NWA, file = here::here("data", "NWA_Hovmoller.csv"))
```
...
NWA <- fread(here::here("data", "NWA_Hovmoller.csv"))
