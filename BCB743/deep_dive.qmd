...
#| eval: false
write.csv(spp_df2, file = here::here("data", "BCB743", "seaweed", "spp_df2.csv"))
```
...
plt5a <- spp_long %>%
  ...
  geom_line(stat = "smooth", method = "lm", formula = y ~ x, alpha = 1.0,
            linewidth = 0.6, colour = "black", aes(linetype = bio)) +
...
plt5b <- spp_long %>%
  ...
  geom_line(stat = "smooth", method = "lm", formula = y ~ x,
            alpha = 1.0, linewidth = 0.6, colour = "black", aes(linetype = bio)) +
...
plt5g <- spp_long %>%
  ...
  geom_point(aes(colour = bio, shape = bio), size = 1.2, alpha = 0.8) +
  # geom_point(aes(colour = bio, size = bio, alpha = bio, shape = bio)) +
  geom_line(stat = "smooth", method = "lm", formula = y~x, alpha = 1.0, linewidth = 0.6,
            colour = "black",
            aes(linetype = bio)) +
