---
date: last-modified
title: "16: Deep Dive into Gradients"
format:
  html: default
---
...
These integer ranges are an operationalisation for pairwise within-region comparisons in this analysis. They deliberately use non-overlapping blocks, so they differ slightly from the prose bioregion ranges used elsewhere, where transition zones overlap adjacent provinces (for example BMP 1--17 and B-ATZ 18--22).
...
I extract the slices (groups of rows) of the original species table into separate dataframes, one for each of the four bioregions:
