...
With an ordination in front of us, the arch effect is easy to see. @fig-ca-arch redraws the site scores and joins the sites in river order, from the source (site 1) to the mouth. The sites do not fall on a straight line along CA1. They bow into an arch, rising on CA2 in the middle of the river and falling again towards each end.
