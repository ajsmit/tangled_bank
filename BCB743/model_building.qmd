...
1. **Start from hypotheses.** Each candidate model should express an ecological idea, for example "turnover tracks the mean gradient" against "turnover tracks thermal variability". A model with no hypothesis behind it should not be in the set.
...
8. **Reconcile the two kinds of evidence.** Trust most the conclusions where ecology and statistics agree, and report honestly where they do not.
