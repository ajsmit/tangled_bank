...
SDG1.a <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG1.a_domestic_health_expenditure.csv")) %>%
  filter(Period == 2016) %>%
...
SDG3.1_1 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.1_maternal_mort.csv")) %>%
  filter(Period == 2016,
...
SDG3.1_2 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.1_skilled_births.csv")) %>%
  filter(Period == 2016) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.1_2")
```
...
SDG3.2_1 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.2_neonatal_deaths.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.2_1")
...
SDG3.2_2 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.2_under_5_deaths.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.2_2")
...
SDG3.2_3 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.2_infant_deaths.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.2_3")
...
SDG3.3_1 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.3_new_HIV_infections.csv")) %>%
  filter(Period == 2015,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.3_1")
...
SDG3.3_2 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.3_TB.csv")) %>%
  filter(Period == 2016) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.3_2")
```
...
SDG3.3_3 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.3_malaria.csv")) %>%
  filter(Period == 2016) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.3_3")
```
...
SDG3.3_4 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.3_hepatitis_B.csv")) %>%
  filter(Period == 2015) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.3_4")
```
...
SDG3.3_5 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.3_NCD_interventions.csv")) %>%
  filter(Period == 2016) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.3_5")
```
...
SDG3.4_1 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.4_adult_death_prob.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.4_1")
...
SDG3.4_2 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.4_NCD_by_cause.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes",
...
SDG3.4_3 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.4_NCD_by_cause.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes",
...
SDG3.4_4 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.4_NCD_by_cause.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes",
...
SDG3.4_5 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.4_suicides.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.4_5")
...
SDG3.4_6 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.4_NCD_data_total.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.4_6")
...
SDG3.5 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.5_alcohol_consumption.csv")) %>%
  filter(Period == 2015,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.5")
...
SDG3.6 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.6_traffic_deaths_prop.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.6")
...
SDG3.7 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.7_adolescent_births.csv")) %>%
  filter(Period == 2016) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.7")
```
...
SDG3.8_1 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.8_UHC_data_availability.csv")) %>%
...
SDG3.8_2 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.8_UHC_index_of_service_coverage.csv")) %>%
  filter(Period == 2017) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.8_2")
```
...
SDG3.9_1 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.9_unintentional_poisoning_prop.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.9_1")
...
SDG3.9_3 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.9_WASH_mortalities.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.9_3")
...
SDG16.1 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG16.1_homicides.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG16.1")
...
SDG3.a <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.a_tobacco_control.csv")) %>%
  filter(Period == 2016,
         Dim1 == "Both sexes") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.a")
...
SDG3.b_1 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.b_dev_assistence_for_med_research.csv")) %>%
  filter(Period == 2016) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.b_1")
```
...
SDG3.b_2 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.b_measles_vaccine.csv")) %>%
  filter(Period == 2016) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.b_2")
```
...
SDG3.b_3 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.b_diphtheria_vaccine.csv")) %>%
  filter(Period == 2016) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.b_3")
```
...
SDG3.b_4 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.b_pneumococcal_vaccine.csv")) %>%
  filter(Period == 2016) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.b_4")
```
...
SDG3.b_5 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.b_HPV_vaccine.csv")) %>%
  filter(Period == 2016) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.b_5")
```
...
SDG3.c_1 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.c_health_workforce.csv"))  %>%
  filter(Period == 2016,
         Indicator == "Medical doctors (per 10,000)") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.c_1")

SDG3.c_2 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.c_health_workforce.csv"))  %>%
  filter(Period == 2016,
         Indicator == "Nursing and midwifery personnel (per 10,000)") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.c_2")

SDG3.c_3 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.c_health_workforce.csv"))  %>%
  filter(Period == 2016,
         Indicator == "Dentists (per 10,000)") %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.c_3")

SDG3.c_4 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.c_health_workforce.csv"))  %>%
  filter(Period == 2016,
...
SDG3.d_1 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_SDG3.d_health_risks.csv"))  %>%
  filter(Period == 2016) %>%
  select(Indicator, ParentLocation, Location, FactValueNumeric) %>%
  mutate(SDG = "SDG3.d_1")
```
...
other_1 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_Other_life_expectancy.csv")) %>%
  filter(Period == 2015,
         Dim1 == "Both sexes",
...
other_2 <- read.csv(here::here("data", "BCB743", "WHO", "WHO_Other_life_expectancy.csv")) %>%
  filter(Period == 2015,
         Dim1 == "Both sexes",
...
ggplot(data = site_scores, aes(x = PC1, y = PC2)) +
  ...
  geom_segment(data = species_scores, 
               ...
               colour = "lightseagreen", alpha = 1, linewidth = 0.3) +
