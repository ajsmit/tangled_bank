...
This additional household-expenditure indicator is not included in the analysis below.
...
Some of the variables are multicollinear. See @graham2003confronting for a discussion of collinearity in ecological data and how to deal with it.
...
There seem to be separate groups of colours (ParentLocation). Certain countries come out together in this ordination. This analysis would benefit from a cluster analysis of some kind.
