...
This task uses the data described at the start of the Chapter 5 about [Multiple Regression](../../docs/The-Biostatistics-Book-Ch-3-5.pdf) in The Biostatistics Book. The data can be downloaded [here](../../data/BCB743/seaweed/SeaweedSpp.csv).
