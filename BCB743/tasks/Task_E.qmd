...
3. Apply DCA to a second dataset with a different gradient length --- for example the dune meadow data (`data(dune)`) or the [bird communities along the elevation gradient in Yushan Mountain, Taiwan](https://www.davidzeleny.net/anadat-r/doku.php/en:data:ybirds) --- and report its first-axis gradient length.

4. Extract the DCA species scores and identify which species characterise each end of axis 1; relate them to the upstream-downstream gradient of the river.
