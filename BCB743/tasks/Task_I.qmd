...
Work through these questions after reading the [Cluster Analysis](../cluster_analysis.qmd) chapter.
...
<!-- Submit a Quarto HTML document wherein you provide answers to Questions 1--4 by the deadline in the syllabus schedule. -->

<!-- Provide a **neat and thoroughly annotated** Quarto/html file which outlines the graphs and all calculations and which displays the resultant distance matrix. Use separate tabs for the different questions. -->

<!-- Please label the Quarto and resulting HTML files as follows: -->

<!-- -   `BCB743_<first_name>_<last_name>_Task_I.qmd`, and -->

<!-- -   `BCB743_<first_name>_<last_name>_Task_I.html` -->
