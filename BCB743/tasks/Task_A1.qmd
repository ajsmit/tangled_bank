...
- work in pairs and run the assignment as a complete small research project, from ecological question to reproducible analysis to written interpretation
...
Each submission should include a short author-contribution statement explaining what each member of the pair contributed. If you used generative AI tools, also include a brief disclosure stating what they were used for and how the final work was checked by the authors.

### Assessment criteria

This assignment will be formally assessed and counts 50% to the final BCB743 mark. It will be assessed as a research project, not as a collection of disconnected analyses. Your mark will reflect the quality of the ecological argument, the appropriateness and creativity of the analysis, the depth of interpretation, and the clarity of the written paper.
...
- **Collaboration:** both members of the pair are responsible for the full project. The submitted work should show evidence of shared intellectual ownership rather than two unrelated halves joined at the end.
