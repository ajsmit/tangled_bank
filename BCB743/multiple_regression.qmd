...
* The [integrative mini-research project](assessments/BCB743_integrative_assignment.qmd) applies multiple regression (and constrained ordination) to the seaweed data; [Task G](tasks/Task_G.qmd) is the matching practice run.
