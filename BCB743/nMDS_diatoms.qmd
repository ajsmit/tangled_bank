...
spp <- read.csv(here::here("data", "diatoms", "PB_data_matrix_abrev.csv"),
                row.names = "Replicate", sep = ",", header = TRUE)
spp[1:6, 1:6]

# with full names
spp2 <- read.csv(here::here("data", "diatoms", "PB_data_matrix.csv"),
                 row.names = "Replicate", sep = ",", header = TRUE)
spp2[1:6, 1:6]
...
env <- tibble(read.csv(here::here("data", "diatoms", "PB_diat_env.csv")),
              sep = ",", header = TRUE)
