...
:::{.callout-important}
## Lab 4 (continue)
**These questions are a continuation of Lab 4 in the [Principal Analysis Section (SDGs)](08-PCA_SDG.qmd) section; refer to that section for additional questions to submit together with this analysis.** This is the final set of questions for Quantitative Ecology. 
