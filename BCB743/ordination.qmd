...
Ordination is a multivariate statistical technique used to analyse and visualise complex, high-dimensional data, such as ecological community data. While [clustering methods](cluster_analysis.qmd) focus on identifying discontinuities or groups within the data, ordination aims to highlight and interpret gradients, which are ubiquitous in ecological communities.

Ordination is particularly well-suited for handling multivariate data, which can represent:
