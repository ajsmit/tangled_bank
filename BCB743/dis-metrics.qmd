...
- **Definition**: We calculate the Bray-Curtis dissimilarity index as:
  $$
...
- **Definition**: We define the Sørensen dissimilarity as:
  $$
  D_S = 1 - \frac{2C}{A + B}
  $$
...
- **Definition**: We define the Jaccard index as:
  $$
  D_J = 1 - \frac{C}{A + B - C}
  $$
...
- **Definition**: We calculate Hellinger distance using the Hellinger transformation:
  $$
...
- **Definition**: The Gower distance is a general similarity coefficient that can handle different types of variables (quantitative, binary, categorical). We calculate it as:
  $$
...
- **Definition**: We calculate the Canberra distance as:
  $$
