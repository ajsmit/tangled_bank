...
::: {.tb-course-hero}
[BCB743 · Honours elective]{.tb-course-eyebrow}

# Quantitative Ecology {.tb-course-title}

[Use ecological theory, multivariate statistics, and reproducible R workflows
to explain gradients, community structure, species turnover, and the processes
that assemble ecological communities.]{.tb-course-lede}

::: {.tb-course-actions}
[View the module schedule](#module-content-and-framework){.tb-action .tb-action-primary}
[Start with correlations](correlations.qmd){.tb-action .tb-action-secondary}
:::
:::
...
Multivariate structure in ecological communities
:::

::: {.tb-course-fact}
[Approach]{.tb-course-fact-label}

Theory, worked analyses, and collaborative assignments
:::

::: {.tb-course-fact}
[Tools]{.tb-course-fact-label}

R, **vegan**, and real ecological datasets
:::
:::

::: {.tb-teaching .tb-learning-objectives}

- Explain diversity patterns and species-assembly processes across scales.
- Design and prepare ecological data for quantitative analysis.
- Apply ordination, dissimilarity, clustering, and regression methods in R.
- Interpret multivariate results in relation to ecological hypotheses and limitations.
:::
...
Revise biodiversity in [BDC334](../BDC334/BDC334_syllabus.qmd), refresh the R
and statistics taught in [BCB744](../BCB744/BCB744_index.qmd), and inspect the
[module datasets](datasets.qmd).
:::
...
Move from correlations and distance metrics through unconstrained and
constrained ordination, clustering, and regression.
:::

::: {.tb-course-path-step}
[03]{.tb-course-path-number}

### Build an ecological argument

Use the practice tasks and three assessed assignments to connect reproducible
analysis, evidence, ecological theory, and clear communication.
:::
:::
...
|                                              |            | 1 · *self-study*         | Revision: biodiversity (BDC334)              | [Labs 1–4](../BDC334/BDC334_syllabus.qmd) |                                                          | [Smit 2013](../docs/Smit_et_al_2013.pdf)                                                           |                                             |        |
|                                              | Thu 18 Jun | 2                        | Correlations & Associations                  | [Notes](correlations.qmd)                 | [Slides](../slides/BCB743_06_correlations.pdf)           | [Biostats Ch. 9][bs-corr]                                                                          | [Task A](tasks/Task_A.qmd)                  |        |
|                                              |            | 3 · *self-study*         | Distance Metrics                             | [Notes](dis-metrics.qmd)                  |                                                          |                                                                                                    |                                             |        |
|                                              |            | 4                        | Intro to Ordination                          | [Notes](ordination.qmd)                   | [Slides](../slides/BCB743_07_ordination.pdf)             |                                                                                                    |                                             |        |
| **W2** · Unconstrained ordination I          | Mon 22 Jun | 5                        | PCA                                          | [Notes](PCA.qmd)                          | [Slides](../slides/BCB743_08_PCA.pdf)                    |                                                                                                    | [Task B](tasks/Task_B.qmd)                  |        |
|                                              |            | 6 · *self-study*         | PCA: Additional Examples                     | [Notes](PCA_examples.qmd)                 |                                                          |                                                                                                    |                                             |        |
|                                              |            | 7 · *self-study*         | PCA: WHO SDGs                                | [Notes](PCA_SDG_example.qmd)              |                                                          |                                                                                                    | [Task C](tasks/Task_C.qmd)                  |        |
|                                              | Tue 23 Jun | 8                        | CA                                           | [Notes](CA.qmd)                           | [Slides](../slides/BCB743_09_CA.pdf)                     |                                                                                                    | [Task D](tasks/Task_D.qmd)                  |        |
|                                              |            | 9                        | DCA                                          | [Notes](DCA.qmd)                          |                                                          |                                                                                                    | [Task E](tasks/Task_E.qmd)                  |        |
|                                              | Wed 24 Jun | 10                       | PCoA                                         | [Notes](PCoA.qmd)                         | [Slides](../slides/BCB743_10_PCoA.pdf)                   |                                                                                                    | [Task F](tasks/Task_F.qmd)                  |        |
|                                              | Thu 25 Jul | 11                       | nMDS                                         | [Notes](nMDS.qmd)                         | [Slides](../slides/BCB743_11_nMDS.pdf)                   |                                                                                                    | [Task G](tasks/Task_G.qmd)                  |        |
|                                              |            | 12 · *self-study*        | nMDS: PERMANOVA (diatoms)                    | [Notes](nMDS_diatoms.qmd)                 |                                                          | [Mayombo 2019](../docs/Mayombo_et_al_2019.pdf)                                                     |                                             |        |
|                                              |            | 13 · *self-study*        | Unconstrained Ordination: Summary            | [Notes](unconstrained-summary.qmd)        |                                                          |                                                                                                    |                                             |        |
| **W3** · Assignment work (self)              |            |                          |                                              |                                           |                                                          |                                                                                                    |                                             |        |
| **W4** · Constrained ordination & clustering | Thu 9 Jul  | 14                       | Distance-based Redundancy Analysis           | [Notes](constrained_ordination.qmd)       | [Slides](../slides/BCB743_12_constrained_ordination.pdf) | [Smit 2017](../docs/Smit_et_al_2017.pdf) [Seaweed data](../docs/Smit_the_seaweed_data.pdf)         | [Task H](tasks/Task_H.qmd)                  |        |
|                                              |            | 15 · *self-study*        | db-RDA: Revisiting the β-diversity Partition | [Notes](constrained_ordination_v2.qmd)    |                                                          |                                                                                                    |                                             |        |
|                                              |            | 16 · *self-study*        | Seaweeds in Two Oceans                       | [Notes](two_oceans_appendices.qmd)        |                                                          | [Smit 2017](../docs/Smit_et_al_2017.pdf) [Seaweed data](../docs/Smit_the_seaweed_data.pdf)         |                                             |        |
|                                              | Fri 10 Jul | 17                       | Cluster Analysis                             | [Notes](cluster_analysis.qmd)             |                                                          |                                                                                                    | [Task I](tasks/Task_I.qmd)                  |        |
| **W5** · Regression I                        | Mon 13 Jul | 18                       | Model Building                               | [Notes](model_building.qmd)               |                                                          | [Biostats Ch. 17][bs-check] [Ch. 24][bs-pred]                                                      | [Task J](tasks/Task_J.qmd)                  |        |
|                                              |            | 19 · *self-study*        | Deep Dive Into Gradients                     | [Notes](deep_dive.qmd)                    |                                                          | [Smit 2013](../docs/Smit_et_al_2013.pdf) [Smit 2017](../docs/Smit_et_al_2017.pdf)                  |                                             |        |
|                                              | Tue 14 Jul | 20                       | Multiple Regression                          | [Notes](multiple_regression.qmd)          |                                                          | [Biostats Ch. 14][bs-mlr] [Ch. 16][bs-collin]                                                      | [Task K](tasks/Task_K.qmd)                  |        |
|                                              | Thu 16 Jul | 21                       | Generalised Linear Models                    | [Notes](glm.qmd)                          |                                                          | [Biostats Ch. 20][bs-glm]                                                                          | [Task L](tasks/Task_L.qmd)                  |        |
| **W6** · Regression II & wrap-up             | Mon 20 Jul | 22                       | Generalised Additive Models                  | [Notes](gam.qmd)                          |                                                          | [Biostats Ch. 21][bs-gam]                                                                          | [Task M](tasks/Task_M.qmd)                  |        |
|                                              | Tue 21 Jul | 23                       | Mixed Models                                 | [Notes](mixed_models.qmd)                 |                                                          | [Mayombo 2019](../docs/Mayombo_et_al_2019.pdf) [Biostats Ch. 18][bs-pseudo] [Ch. 19][bs-mixed]     | [Task N](tasks/Task_N.qmd)                  |        |
|                                              |            | 24 · *self-study*        | Complete Multivariate Analysis (Doubs)       | [Notes](doubs_multivariate.qmd)           |                                                          |                                                                                                    |                                             |        |
