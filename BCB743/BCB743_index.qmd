...
- **Multivariate Analyses:** Here, you will learn how to utilise multivariate statistics to make sense of complex systems, predict ecological outcomes, and understand the underlying mechanisms that drive ecological processes.
...
|                                              |            |                          | Textbook                                     |                                           |                                                          |                                                                                                    | [Textbook](tasks/Task_A2.qmd)               | 17 Jul |
...
There are various tasks in this module. Only the **Integrative Assessment** and the **Textbook** will be assessed, and both carry 50% towards the final mark for the module. The Tasks (A--N) will not be assessed and are for self-practice. We can discuss your solutions in class if necessary, should you require additional help.
...
| 7 | World Health Organisation Sustainable Development Goals Data | [**WHO**](https://www.who.int/data)                                                           |
...
**Cooperative learning is not a licence for plagiarism. Plagiarism is a serious offence and will be dealt with concisely. Consequences of cheating are severe --- they range from a 0% for the assignment or exam up to dismissal from the module for a second offense.** 
...
Once a question has been answered, the issue will be closed, so lots of good answers might end up in closed issues. Do not forget to look there when looking for answers --- you can use the **Search** feature on this repository to find answers that might have been offered by the same or similar problem experienced by someone else in the past.
