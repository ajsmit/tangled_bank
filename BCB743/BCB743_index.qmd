...
Tom Spencer-Hicken---Department of Biodiversity & Conservation Biology, 3941863@myuwc.ac.za

# Module description

Quantitative ecology is a field within the ecological sciences that uses statistical and computational approaches to understand ecosystems. It aims to describe and quantify ecological processes, analyse and model complex multivariate ecological data, and make predictions about the structure and dynamics of ecosystems across a range of spatial and temporal scales. The multivariate statistical approaches taught in this module will prepare the student to make sense of bewildering multidimensional datasets in a comprehensible two- or three-dimensional space.

Coursework on quantitative ecology can cover topics such as:

-   **Ecological structure** We will cover the basic principles underlying the environmental structuring of ecosystems (ecosystem structure).

-   **Ecological data analysis** This involves studying statistical techniques to analyse ecological data, including hypothesis testing, regression analysis, and multivariate analysis.

-   **Multivariate analyses** In this section, we learn how to use multivariate statistics to make sense of complex systems, predict ecological outcomes, and understand the underlying mechanisms that drive ecological processes.

-   **Spatial ecology** Here we learn how to analyse and model spatial patterns in ecological data, including the distribution of species and habitats across landscapes.

-   **Population dynamics** This is the theory about how to model and analyse the dynamics of populations, including birth and death rates, population growth, and interactions between species.

-   **Community ecology** Theory in this section of the work deals with analysing and modelling the interactions between species within ecological communities, including competition, predation, and mutualism.

-   **Ecosystem ecology** Here we will learn how to model and analyse the flow of energy and nutrients through ecosystems, including the role of producers, consumers, and decomposers in ecological processes.

So, a course in quantitative ecology provides you with the skills and tools needed to analyse and model ecological data, communities, and make predictions about the structure and dynamics of ecosystems. It prepares students for careers in research, conservation, natural resource management, and environmental consulting.

In BCB743 I will focus on **multivariate statistics**. Multivariate methods play a central role in quantitative ecology as they enable researchers to analyse and interpret complex data sets that involve multiple variables and hordes of species. Ecological systems are characterised by their complexity, and there are typically many different factors that influence the distribution and abundance of species in an ecosystem. Multivariate statistical methods allow us to identify the underlying patterns and relationships among these variables and to explore how they interact to shape ecological communities.

Some of the most commonly used multivariate statistical techniques in quantitative ecology include ordination methods, such as principal component analysis (PCA) and correspondence analysis (CA), which are used to reduce complexity and permit the visualisation of patterns of species distribution in ecological communities. Cluster analysis, discriminant analysis, and canonical correlation analysis are other multivariate methods commonly used to analyse ecological data. These techniques can help us to identify groups of species or environmental factors that are associated with particular ecological conditions, as well as to assess the relative importance of different variables in shaping ecological communities.

In addition to providing a framework for data analysis, multivariate statistics also play an important role in developing ecological models. By incorporating multivariate data into models, we can gain a more complete understanding of the ecological processes that govern the behaviour of species and ecosystems. This, in turn, can inform management and conservation efforts aimed at preserving ecological diversity and resilience in the face of environmental change. Multivariate statistics are an essential tool for ecologists seeking to understand the complex relationships between species and their environment.
...
work through these examples and workflows. Here is the Syllabus:

:::{.column-page-inset-right}
| Week | Class date | Lecture  | Topic                            | Class                                                  | Slides                                                                         | Reading                                                                                                                                                        | Tasks                                                                       | Tasks due  |
|------|------------|----------|----------------------------------|--------------------------------------------------------|--------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|------------|
| W1   | 20 June    | L1       | Introduction                     |                                                        | [😳](../slides/BCB743_01_intro.pdf)                  | [🥴](../docs/BES-Reproducible-Code-2017.pdf) [🥴](../docs/BES-Data-Guide-2017_web.pdf)                                       | [😱](assessments/Task_A.qmd)                       | 27 June    |
|      |            |          | **BIODIVERSITY**                 |                                                        |                                                                                |                                                                                                                                                                |                                                                             |            |
|      |            | revision | Ecological Data                  | [😭](../BDC334/01-introduction.qmd)                    |                                                                                |                                                                                                                                                                | Lab 1 Review                                                                |            | 
|      |            |          | **DATA, MATRICES**               |                                                        |                                                                                |                                                                                                                                                                |                                                                             |            |
|      |            | revision | Environmental Distance           | [😭](../BDC334/02b-env_dist.qmd)                        | [😳](../slides/BCB743_04_environmental_distance.pdf) |                                                                                                                                                                | Lab 2 Review                                                                |            | 
|      |            | revision | Quantifying Biodiversity         | [😭](../BDC334/03-biodiversity1.qmd)                    | [😳](../slides/BCB743_02_biodiversity_1.pdf)         | [🥴](../docs/Smit_et_al_2013.pdf) [🥴](../docs/Smit_et_al_2017.pdf) [🥴](../docs/Smit_the_seaweed_data.pdf) | Lab 3 Review                                                                |            |
|      |            | revision | Describing Biodiversity Patterns | [😭](../BDC334/04-biodiversity2.qmd)                    | [😳](../slides/BCB743_02_biodiversity_2.pdf)         | [🥴](../docs/Shade_et_al_2018.pdf)                                                                                                            | Lab 4 Review                                                                |            |
|      |            | revision | Ecological Theories              |                                                        |                                                                                |                                                                                                                                                                |                                                                             |            | 
| W1   | 22 June    | L2       | Correlations and Associations    | [😭](05-correlations.qmd)                               | [😳](../slides/BCB743_06_correlations.pdf)           |                                                                                                                                                                | [😱](assessments/Task_B.qmd)                       | 23 June    |
...
|      |            |          | **ORDINATION**                   |                                                        |                                                                                |                                                                                                                                                                |                                                                             |            | 
| W2   | 27 June    | L3       | Ordination                       |                                                        | [😳](../slides/BCB743_07_ordination.pdf)             |                                                                                                                                                                |                                                                             |            |
|      |            | L3       | PCA (a)                          | [😭](08-PCA.qmd)                                        | [😳](../slides/BCB743_08_PCA.pdf)                    |                                                                                                                                                                | [😱](assessments/Task_C.qmd)                       | 28 June    |
|      |            | self     | PCA (b) Additional Examples      | [😭](08-PCA_examples.qmd)                               |                                                                                |                                                                                                                                                                |                                                                             |            | 
|      |            | self     | PCA (c) WHO SDGs                 | [😭](08-PCA_SDG.qmd)                                                       |                                                                                |                                                                                                                                                                | [😱](assessments/Task_D.qmd)                       | 19 July    | 
| W3   | 4 July     | L4       | CA                               | [😭](09-CA.qmd)                                         | [😳](../slides/BCB743_09_CA.pdf)                     |                                                                                                                                                                | [😱](assessments/Task_E.qmd)                       | 5 July     |
|      | 6 July     | L5       | PCoA                             | [😭](10-PCoA.qmd)                                       | [😳](../slides/BCB743_10_PCoA.pdf)                   |                                                                                                                                                                | [😱](assessments/BCB743_intgrative_assignment.qmd) | 7 July     |
| W4   | 11 July    | L6       | nMDS                             | [😭](11-nMDS.qmd)                                       | [😳](../slides/BCB743_11_nMDS.pdf)                   |                                                                                                                                                                | [😱](assessments/Task_F.qmd)                       | 12 July    |
|      |            | self     | nMDS + PERMANOVA (diatoms)       | [😭](11-nMDS_diatoms.qmd)                               |                                                                                | [🥴](../docs/Mayombo_et_al_2019.pdf)                                                                                                          |                                                                             |            | 
|      | 13 July    | L7       | CCA & RDA                        | [😭](12-constrained_ordination.qmd)                     | [😳](../slides/BCB743_12_constrained_ordination.pdf) | [🥴](../docs/Smit_et_al_2017.pdf) [🥴](../docs/Smit_the_seaweed_data.pdf)                                                    |                                                                             |            |
|      |            |          | **CLUSTER ANALYSIS**             |                                                        |                                                                                |                                                                                                                                                                |                                                                             |            | 
| W5   | 18 July    | L8       | Cluster Analysis                 | [😭](13-cluster_analysis.qmd)                          |                                                                                |                                                                                                                                                                | [😱](assessments/Task_D.qmd)                       | 19 July    |
|      |            | L9       | Review & Integrative Assignment  |                                                        |                                                                                |                                                                                                                                                                | [😱](assessments/BCB743_intgrative_assignment.qmd) | 2 August   |
| W7   | 3--4 Aug   |          | **EXAM**                         |                                                        |                                                                                |                                                                                                                                                                |                                                                             | 4 August   |                                           
:::
...
**Competence** Data collection aimed at a quantitative test of the
relevant hypotheses, above. The management and analysis of ecological
data; reproducible and collaborative research; the use of R as a tool
for the analysis multivariate ecological data; multivariate techniques
such as nMDS, PCA, RDA and cluster analysis; graphical data summaries
and visualisations.
...
**Continuous Assessments** (CA) and a **Final Assessment** will provide a **Final Mark** for the module. These modes of assessment meet our needs as far as [formative and summative assessments](../pages/assessment_theory.qmd) are concerned. The weighting of the CA and the Final Assessment is 0.6 and 0.4,
...
end, a series of mini-projects (**Tasks**) involving real data are a
...
Tasks are due by the date and time indicated, and due care must be
...
this will be in Quarto format (.qmd) and the knitted output (I prefer
.html).

The Continuous Assessment is comprised of the material indicated in
the Syllabus by the <i class="fa-balance-scale-right"></i> icon.
...
The Final Assessment will be a 48-hour affair that you can do in the comfort of your
