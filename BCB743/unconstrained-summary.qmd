...
The next chapter turns to *constrained* ordination ([RDA, CCA, and db-RDA](constrained_ordination.qmd)), where environmental variables actively determine the ordination axes, so that we can ask how much of the community pattern they explain and test it formally.
