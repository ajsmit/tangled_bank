...
| Type | Name                           | Link                                   |
|---------------|--------------------|-------------------------------------|
| Data | The seaweed environmental data | [💾](../data/seaweed/SeaweedEnv.RData) |
|      | The seaweed species data       | [💾](../data/seaweed/dists_mat.RData)  |
|      | The bioregions                 | [💾](../data/seaweed/bioregions.csv)   |
...
spp <- read.csv('../data/seaweed/SeaweedsSpp.csv')
