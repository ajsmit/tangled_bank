...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, opacityback=0, rightrule=.15mm, colback=white, leftrule=.75mm, colframe=quarto-callout-note-color-frame, breakable, left=2mm, toprule=.15mm, arc=.35mm]
