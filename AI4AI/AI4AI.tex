...
\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, left=2mm, opacityback=0, rightrule=.15mm, leftrule=.75mm, colback=white, arc=.35mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame]
