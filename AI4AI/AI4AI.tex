...
\begin{tcolorbox}[enhanced jigsaw, breakable, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, arc=.35mm, left=2mm, leftrule=.75mm, colback=white, toprule=.15mm, rightrule=.15mm, opacityback=0]
